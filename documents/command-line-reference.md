...
| WebAssembly commands: module loading, explicit start-function invocation, preloaded Wasm modules, native preload DLs, import binding rewrites, weak symbols, parser/initializer limits, memory limits, preload memory attributes, and strict memory growth. | [wasm.md](command-line/wasm.md) |
| Runtime commands: runtime mode/compiler selection, shortcut conflicts, LLVM IR verifier control, compile-thread policies, scheduling, and compiler logs. | [runtime.md](command-line/runtime.md) |
