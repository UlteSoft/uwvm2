...
// third-parties/boost_unordered/include test/0013.uwvm_int/uwvm_int_register_ring_codegen.cc -o /tmp/uwvm_int_register_ring_codegen.s`
[[gnu::noinline]] ::std::byte* codegen_spill_i32_2(::std::byte const* op, ::std::byte* sp, ::std::byte* local_base, wasm_i32 r3, wasm_i32 r4) noexcept
{
                                                           ...
                                                           optable::wasm_stack_top_i32_with_i64_u s4) noexcept
{
    ...
    optable::manipulate::spill_stacktop_to_operand_stack<opt, 4uz, wasm_i64, wasm_i32>(op, sp, local_base, s3, s4);
    codegen_keep(sp);
    return sp;
}
