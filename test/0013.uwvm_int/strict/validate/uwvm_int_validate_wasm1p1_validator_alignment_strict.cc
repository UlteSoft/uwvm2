...
namespace
{
    ...
    [[nodiscard]] byte_vec build_invalid_select_t_zero_result_types_module()
    {
        module_builder mb{};
    ...
    [[nodiscard]] int run_common_wasm1p1_error_suite_for_opt() noexcept
    {
        ...
        UWVM2TEST_REQUIRE(compile_expect_error<Opt>(full::build_invalid_select_t_count_module(),
                                                    u8"uwvm2test_strict_full_select_two_result_arity",
                                                    all_features,
    ...
    [[nodiscard]] int run_alignment_suite_for_opt() noexcept
    {
        ...
        UWVM2TEST_REQUIRE(compile_expect_error<Opt>(build_invalid_select_t_zero_result_types_module(),
                                                    u8"uwvm2test_wasm1p1_select_t_zero_arity",
                                                    select_features,
                                                    errc::invalid_const_immediate) == 0);
