...
namespace
{
    ...
    [[nodiscard]] byte_vec build_if_else_then_end_restore_module()
    {
        module_builder mb{};
        ...
        //   frame.type == else_ && !frame.then_polymorphic_end && frame.stacktop_has_then_end_state
        {
            ...
            // else: become polymorphic, but still include mixed stack ops to stress codegen.
            ...
            // carried + if_result == 42 (when cond != 0)
    ...
    [[nodiscard]] int run_if_else_then_end_restore_suite(runtime_module_t const& rt) noexcept
    {
        ...
        // Only run the then-path (cond=1). Else-path traps.
    ...
    [[nodiscard]] int test_translate_if_else_then_end_restore() noexcept
    {
        ...
        auto wasm = build_if_else_then_end_restore_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_if_else_then_end_restore");
        ...
        // byref
        {
            ...
            UWVM2TEST_REQUIRE(run_if_else_then_end_restore_suite<opt>(rt) == 0);
        }
...
int main()
{
    return test_translate_if_else_then_end_restore();
}
