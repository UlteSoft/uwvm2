...
namespace
{
    ...
    [[nodiscard]] byte_vec build_br_if_i64_eqz_stacktop_nofill_module()
    {
        module_builder mb{};
        ...
        // f0: (param i64) -> (result i32)
        // block (result i32)
        //   i32.const taken
        //   local.get 0; i64.eqz; br_if 0
        //   drop
        //   i32.const fall
        // end
        {
    ...
    [[nodiscard]] int test_translate_br_if_i64_eqz_stacktop_nofill() noexcept
    {
        ...
        auto wasm = build_br_if_i64_eqz_stacktop_nofill_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_br_if_i64_eqz_stacktop_nofill");
...
int main()
{
    try
    {
        return test_translate_br_if_i64_eqz_stacktop_nofill();
    }
    catch(...)
    {
