...
namespace
{
    ...
    [[nodiscard]] int test_translate_br_table_with_values() noexcept
    {
        ...
        if(abi_mode_enabled("tail-min"))
        {
            ...
            UWVM2TEST_REQUIRE(bytecode_has_br_table_fptr<opt>(cm.local_funcs.index_unchecked(0)));
            UWVM2TEST_REQUIRE(bytecode_has_br_table_fptr<opt>(cm.local_funcs.index_unchecked(1)));
            UWVM2TEST_REQUIRE(bytecode_has_br_table_fptr<opt>(cm.local_funcs.index_unchecked(2)));
            UWVM2TEST_REQUIRE(bytecode_has_br_table_fptr<opt>(cm.local_funcs.index_unchecked(3)));
