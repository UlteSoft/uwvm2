...
namespace
{
    ...
    [[nodiscard]] byte_vec build_i64_compare_localget_fuse_module()
    {
        module_builder mb{};
        ...
        auto add_cmp_brif_func = [&](wasm_op cmp, ::std::int32_t true_v, ::std::int32_t false_v) -> void
        {
            ...
            op(c, wasm_op::block);
            append_u8(c, 0x7f);  // (result i32)
            op(c, wasm_op::i32_const);
            append_i32_leb(c, true_v);
            op(c, wasm_op::local_get);
            u32(c, 0u);
            op(c, wasm_op::i64_const);
            i64(c, 7);
        ...
        add_cmp_func(wasm_op::i64_eq);    // f0
        add_cmp_func(wasm_op::i64_ne);    // f1
        add_cmp_func(wasm_op::i64_lt_s);  // f2
        add_cmp_func(wasm_op::i64_lt_u);  // f3
        add_cmp_func(wasm_op::i64_ge_s);  // f4
        add_cmp_func(wasm_op::i64_ge_u);  // f5
        add_cmp_func(wasm_op::i64_gt_s);  // f6
        add_cmp_func(wasm_op::i64_gt_u);  // f7
        add_cmp_func(wasm_op::i64_le_s);  // f8
        add_cmp_func(wasm_op::i64_le_u);  // f9

        // f10: local.get ; i64.const ; i64.ne ; br_if
        {
            func_type ty{{k_val_i64}, {k_val_i32}};
            func_body fb{};
            auto& c = fb.code;
        ...
        // f11: local.get ; i64.const ; i64.lt_u ; br_if
        {
            func_type ty{{k_val_i64}, {k_val_i32}};
            func_body fb{};
            auto& c = fb.code;
        ...
        add_cmp_brif_func(wasm_op::i64_eq, 77, 88);      // f14
        add_cmp_brif_func(wasm_op::i64_lt_s, 99, 111);   // f15
        add_cmp_brif_func(wasm_op::i64_ge_s, 123, 124);  // f16
        add_cmp_brif_func(wasm_op::i64_ge_u, 135, 136);  // f17
        add_cmp_brif_func(wasm_op::i64_gt_s, 147, 148);  // f18
        add_cmp_brif_func(wasm_op::i64_gt_u, 159, 160);  // f19
        add_cmp_brif_func(wasm_op::i64_le_s, 171, 172);  // f20
        add_cmp_brif_func(wasm_op::i64_le_u, 183, 184);  // f21
    ...
    [[nodiscard]] int run_suite(runtime_module_t const& rt) noexcept
    {
        ...
        if constexpr(Opt.is_tail_call)
        {
            ...
            constexpr auto exp_eq = optable::translate::get_uwvmint_i64_eq_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_ne = optable::translate::get_uwvmint_i64_ne_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_lt_s = optable::translate::get_uwvmint_i64_lt_s_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_lt_u = optable::translate::get_uwvmint_i64_lt_u_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_ge_s = optable::translate::get_uwvmint_i64_ge_s_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_ge_u = optable::translate::get_uwvmint_i64_ge_u_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_gt_s = optable::translate::get_uwvmint_i64_gt_s_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_gt_u = optable::translate::get_uwvmint_i64_gt_u_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_le_s = optable::translate::get_uwvmint_i64_le_s_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_le_u = optable::translate::get_uwvmint_i64_le_u_imm_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_eqz = optable::translate::get_uwvmint_i64_eqz_localget_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_eq = optable::translate::get_uwvmint_br_if_i64_eq_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_ne = optable::translate::get_uwvmint_br_if_i64_ne_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_lt_s = optable::translate::get_uwvmint_br_if_i64_lt_s_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_lt_u = optable::translate::get_uwvmint_br_if_i64_lt_u_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_ge_s = optable::translate::get_uwvmint_br_if_i64_ge_s_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_ge_u = optable::translate::get_uwvmint_br_if_i64_ge_u_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_gt_s = optable::translate::get_uwvmint_br_if_i64_gt_s_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_gt_u = optable::translate::get_uwvmint_br_if_i64_gt_u_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_le_s = optable::translate::get_uwvmint_br_if_i64_le_s_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_le_u = optable::translate::get_uwvmint_br_if_i64_le_u_imm_fptr_from_tuple<Opt>(curr, tuple);
            constexpr auto exp_brif_eqz = optable::translate::get_uwvmint_br_if_i64_local_eqz_fptr_from_tuple<Opt>(curr, tuple);
        ...
        auto expect_eq = [](::std::int64_t x) constexpr -> ::std::int32_t { return static_cast<::std::int32_t>(x == 7); };
        auto expect_ne = [](::std::int64_t x) constexpr -> ::std::int32_t { return static_cast<::std::int32_t>(x != 7); };
        auto expect_lt_s = [](::std::int64_t x) constexpr -> ::std::int32_t { return static_cast<::std::int32_t>(x < 7); };
        auto expect_lt_u = [](::std::int64_t x) constexpr -> ::std::int32_t
        { return static_cast<::std::int32_t>(static_cast<::std::uint64_t>(x) < 7u); };
        auto expect_gt_s = [](::std::int64_t x) constexpr -> ::std::int32_t { return static_cast<::std::int32_t>(x > 7); };
        auto expect_gt_u = [](::std::int64_t x) constexpr -> ::std::int32_t
        { return static_cast<::std::int32_t>(static_cast<::std::uint64_t>(x) > 7u); };
        auto expect_le_s = [](::std::int64_t x) constexpr -> ::std::int32_t { return static_cast<::std::int32_t>(x <= 7); };
        auto expect_le_u = [](::std::int64_t x) constexpr -> ::std::int32_t
        { return static_cast<::std::int32_t>(static_cast<::std::uint64_t>(x) <= 7u); };
        auto expect_ge_s = [](::std::int64_t x) constexpr -> ::std::int32_t { return static_cast<::std::int32_t>(x >= 7); };
        ...
        for(::std::int64_t x : {0ll, 6ll, 7ll, 8ll, -1ll, static_cast<::std::int64_t>(0x8000000000000000ull)})
        {
            ...
            auto rr11 = Runner::run(cm.local_funcs.index_unchecked(11),
                                    ...
                                    nullptr,
                                    nullptr);
            UWVM2TEST_REQUIRE(load_i32(rr11.results) == (static_cast<::std::uint64_t>(x) < 7u ? 33 : 44));

            auto rr12 = Runner::run(cm.local_funcs.index_unchecked(12),
            ...
            auto rr17 = Runner::run(cm.local_funcs.index_unchecked(17),
                                    ...
                                    nullptr,
                                    nullptr);
            UWVM2TEST_REQUIRE(load_i32(rr17.results) == (static_cast<::std::uint64_t>(x) >= 7u ? 135 : 136));
            ...
            auto rr19 = Runner::run(cm.local_funcs.index_unchecked(19),
                                    ...
                                    nullptr,
                                    nullptr);
            UWVM2TEST_REQUIRE(load_i32(rr19.results) == (static_cast<::std::uint64_t>(x) > 7u ? 159 : 160));
            ...
            auto rr21 = Runner::run(cm.local_funcs.index_unchecked(21),
                                    rt.local_defined_function_vec_storage.index_unchecked(21),
                                    pack_i64(x),
                                    nullptr,
                                    nullptr);
            UWVM2TEST_REQUIRE(load_i32(rr21.results) == (static_cast<::std::uint64_t>(x) <= 7u ? 183 : 184));
        }

        return 0;
    }

    [[nodiscard]] int test_translate_i64_compare_localget_fuse() noexcept
    {
        ...
        auto wasm = build_i64_compare_localget_fuse_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_i64_cmp_localget_fuse");
...
int main()
{
    return test_translate_i64_compare_localget_fuse();
}
