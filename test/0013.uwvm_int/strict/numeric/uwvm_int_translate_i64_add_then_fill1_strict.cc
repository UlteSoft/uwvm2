...
namespace
{
    ...
    [[nodiscard]] byte_vec build_i64_add_then_fill1_module()
    {
        module_builder mb{};
    ...
    [[nodiscard]] int test_translate_i64_add_then_fill1() noexcept
    {
        ...
        auto const wasm = build_i64_add_then_fill1_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_i64_add_then_fill1");
        ...
        constexpr auto f_b = optable::translate::get_uwvmint_i64_add_then_fill1_fptr_from_tuple<opt>(curr_b, tuple);
        ...
        auto rr0 = Runner::run(cm.local_funcs.index_unchecked(0),
                               ...
                               nullptr,
                               nullptr);
        UWVM2TEST_REQUIRE(load_i64(rr0.results) == 6);
