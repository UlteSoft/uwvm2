...
namespace
{
    ...
    [[nodiscard]] byte_vec build_f32_add_then_fill1_module()
    {
        module_builder mb{};
        ...
        // - fill a small f32 stacktop ring (2 slots),
        // - spill 1 value to operand-stack memory,
        // - then trigger f32.add_then_fill1 patching at the first f32.add.
        {
    ...
    [[nodiscard]] int test_translate_f32_add_then_fill1() noexcept
    {
        ...
        auto const wasm = build_f32_add_then_fill1_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_f32_add_then_fill1");
        ...
        constexpr auto f_a = optable::translate::get_uwvmint_f32_add_then_fill1_fptr_from_tuple<opt>(curr_a, tuple);
        constexpr auto f_b = optable::translate::get_uwvmint_f32_add_then_fill1_fptr_from_tuple<opt>(curr_b, tuple);
        ...
        auto rr0 = Runner::run(cm.local_funcs.index_unchecked(0),
                               ...
                               nullptr,
                               nullptr);
        UWVM2TEST_REQUIRE(load_f32(rr0.results) == 6.0f);
...
int main()
{
    return test_translate_f32_add_then_fill1();
}
