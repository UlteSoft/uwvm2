...
namespace
{
    ...
    [[nodiscard]] byte_vec build_conbine_i32_imm_localget_bitops_module()
    {
        module_builder mb{};
        ...
        auto add_unary = [&](wasm_op opcode, ::std::int32_t imm) {
        ...
        add_unary(wasm_op::i32_or, static_cast<::std::int32_t>(0x0f0f0f0fu));
        add_unary(wasm_op::i32_xor, static_cast<::std::int32_t>(0x55aa55aau));
        add_unary(wasm_op::i32_shl, 5);
        add_unary(wasm_op::i32_shr_u, 9);
        add_unary(wasm_op::i32_shr_s, 13);
        add_unary(wasm_op::i32_rotl, 7);
        add_unary(wasm_op::i32_rotr, 11);
    ...
    [[nodiscard]] int run_suite(runtime_module_t const& rt) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            ...
            { return optable::translate::get_uwvmint_i32_or_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));

        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            cm.local_funcs.index_unchecked(1).op.operands,
            [&](auto const& curr_variant) constexpr noexcept
            { return optable::translate::get_uwvmint_i32_xor_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));

        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            cm.local_funcs.index_unchecked(2).op.operands,
            [&](auto const& curr_variant) constexpr noexcept
            { return optable::translate::get_uwvmint_i32_shl_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));

        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            cm.local_funcs.index_unchecked(3).op.operands,
            [&](auto const& curr_variant) constexpr noexcept
            { return optable::translate::get_uwvmint_i32_shr_u_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));

        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            cm.local_funcs.index_unchecked(4).op.operands,
            [&](auto const& curr_variant) constexpr noexcept
            { return optable::translate::get_uwvmint_i32_shr_s_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));
#endif
        ...
        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            ...
            [&](auto const& curr_variant) constexpr noexcept
            { return optable::translate::get_uwvmint_i32_rotl_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));

        UWVM2TEST_REQUIRE(bytecode_contains_i32_variant<Opt>(
            cm.local_funcs.index_unchecked(6).op.operands,
            [&](auto const& curr_variant) constexpr noexcept
            { return optable::translate::get_uwvmint_i32_rotr_imm_localget_fptr_from_tuple<Opt>(curr_variant, tuple); }));
#endif

        constexpr ::std::uint32_t x{0x12345678u};
        constexpr ::std::uint32_t neg_x{0xf1234567u};
        ...
        UWVM2TEST_REQUIRE(static_cast<::std::uint32_t>(load_i32(Runner::run(cm.local_funcs.index_unchecked(4),
                                                                            ...
                                                                            pack_i32(static_cast<::std::int32_t>(neg_x)),
                                                                            nullptr,
                                                                            nullptr)
                                                                     .results)) == shr_s32(neg_x, 13u));

        UWVM2TEST_REQUIRE(static_cast<::std::uint32_t>(load_i32(Runner::run(cm.local_funcs.index_unchecked(5),
        ...
        UWVM2TEST_REQUIRE(static_cast<::std::uint32_t>(load_i32(Runner::run(cm.local_funcs.index_unchecked(6),
                                                                            rt.local_defined_function_vec_storage.index_unchecked(6),
                                                                            pack_i32(static_cast<::std::int32_t>(x)),
                                                                            nullptr,
                                                                            nullptr)
                                                                     .results)) == rotr32(x, 11u));

        return 0;
    }

    [[nodiscard]] int test_translate_conbine_i32_imm_localget_bitops() noexcept
    {
        ...
        auto wasm = build_conbine_i32_imm_localget_bitops_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_conbine_i32_imm_localget_bitops");
...
int main()
{
    try
    {
        return test_translate_conbine_i32_imm_localget_bitops();
    }
    catch(...)
    {
