...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_byref_local_plus_imm_nonzero_offset_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
        ...
        // f0: local.get base ; i32.const 24 ; i32.add ; i32.load offset=12
        {
        ...
        // f1: local.get base ; i32.const 16 ; i32.add ; f32.load offset=8
        {
        ...
        // f2: local.get base ; i32.const 20 ; i32.add ; f64.load offset=12
        {
        ...
        // f3: local.get base ; i32.const 28 ; i32.add ; local.get v ; i32.store offset=4 ; reload
        {
...
#if defined(UWVM_ENABLE_UWVM_INT_HEAVY_COMBINE_OPS)
        // f4: local.get base ; i32.const 36 ; i32.add ; local.get v ; f32.store offset=12 ; reload
        {
        ...
        // f5: local.get base ; i32.const 40 ; i32.add ; local.get v ; f64.store offset=16 ; reload
        {
    ...
    [[nodiscard]] int check_byref_bytecode(compiled_module_t const& cm) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(bytecode_contains_fptr(cm.local_funcs.index_unchecked(
#if defined(UWVM_ENABLE_UWVM_INT_HEAVY_COMBINE_OPS)
                                                          3
#else
                                                          1
    ...
    [[nodiscard]] int test_translate_memory_byref_local_plus_imm_nonzero_offset() noexcept
    {
        ...
        auto wasm = build_memory_byref_local_plus_imm_nonzero_offset_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_byref_local_plus_imm_nonzero_offset");
...
int main()
{
    try
    {
        return test_translate_memory_byref_local_plus_imm_nonzero_offset();
    }
    catch(...)
    {
