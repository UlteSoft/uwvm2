...
namespace
{
    ...
    inline constexpr optable::uwvm_interpreter_translate_option_t k_test_tail_float_store_survivor_nonzero_offset_opt{
        .is_tail_call = true,
    ...
    [[nodiscard]] byte_vec build_memory_float_store_local_plus_imm_survivor_nonzero_offset_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
                                          ...
                                          ::uwvm2::object::memory::linear::native_memory_t const& mem) noexcept
    {
        ...
        auto const exp_f32_plain = optable::translate::get_uwvmint_f32_store_fptr_from_tuple<Opt>(curr_f32, mem, tuple);
        auto const exp_f64_plain = optable::translate::get_uwvmint_f64_store_fptr_from_tuple<Opt>(curr_f64, mem, tuple);
    ...
    [[nodiscard]] int check_byref_bytecode(compiled_module_t const& cm) noexcept
    {
        ...
        auto const exp_f32_store =
            optable::translate::get_uwvmint_f32_store_local_plus_imm_fptr<Opt, ::std::byte const*, ::std::byte*, ::std::byte*>(curr_f32);
        auto const exp_f64_store =
            optable::translate::get_uwvmint_f64_store_local_plus_imm_fptr<Opt, ::std::byte const*, ::std::byte*, ::std::byte*>(curr_f64);
        auto const exp_f32_plain = optable::translate::get_uwvmint_f32_store_fptr_from_tuple<Opt>(curr_f32, tuple);
        auto const exp_f64_plain = optable::translate::get_uwvmint_f64_store_fptr_from_tuple<Opt>(curr_f64, tuple);
    ...
    [[nodiscard]] int test_translate_memory_float_store_local_plus_imm_survivor_nonzero_offset() noexcept
    {
        ...
        auto wasm = build_memory_float_store_local_plus_imm_survivor_nonzero_offset_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_float_store_local_plus_imm_survivor_nonzero_offset");
        ...
        static_assert(compiler::details::interpreter_tuple_has_no_holes<k_test_tail_float_store_survivor_nonzero_offset_opt>());
        UWVM2TEST_REQUIRE(compile_check_and_run<k_test_tail_float_store_survivor_nonzero_offset_opt>(rt, true) == 0);
        return 0;
    }
}  // namespace
...
int main()
{
    try
    {
        return test_translate_memory_float_store_local_plus_imm_survivor_nonzero_offset();
    }
    catch(...)
    {
