...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_pending_flush_i64_narrow_plain_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
...

        {
            ...
            op(c, wasm_op::i32_const); i32(c, 120);
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_pending_flush_i64_narrow_plain() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_pending_flush_i64_narrow_plain_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_pending_flush_i64_narrow_plain");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_pending_flush_i64_narrow_plain();
    }
    catch(...)
    {
