...
namespace
{
    ...
    template <optable::uwvm_interpreter_translate_option_t Opt>
    [[nodiscard]] consteval optable::uwvm_interpreter_stacktop_currpos_t make_curr_after_i64_i32_pushes(::std::size_t i64_push_count,
                                                                                                          ::std::size_t i32_push_count) noexcept
    {
        auto curr = make_initial_stacktop_currpos<Opt>();
        if constexpr(Opt.i64_stack_top_begin_pos != SIZE_MAX && Opt.i64_stack_top_begin_pos != Opt.i64_stack_top_end_pos)
        {
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_pending_flush_size_grow_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
    ...
    [[nodiscard]] int check_bytecode(compiled_module_t const& cm) noexcept
    {
        ...
        auto const exp_local_get_i32_initial = optable::translate::get_uwvmint_local_get_i32_fptr_from_tuple<Opt>(curr_initial, tuple);
        auto const exp_local_get_i32_after_i32_1 = optable::translate::get_uwvmint_local_get_i32_fptr_from_tuple<Opt>(curr_after_i32_1, tuple);
        auto const exp_memory_size = optable::translate::get_uwvmint_memory_size_fptr_from_tuple<Opt>(curr_after_i32_2, tuple);
        auto const exp_memory_grow_i32 = optable::translate::get_uwvmint_memory_grow_fptr_from_tuple<Opt>(curr_after_i32_2, tuple);
        ...
        UWVM2TEST_REQUIRE(bytecode_contains_fptr(bc0, exp_local_get_i32_initial));
        UWVM2TEST_REQUIRE(bytecode_contains_fptr(bc0, exp_local_get_i32_after_i32_1));
        UWVM2TEST_REQUIRE(bytecode_contains_fptr(bc0, exp_memory_size));

        UWVM2TEST_REQUIRE(bytecode_contains_fptr(bc1, exp_local_get_i32_initial));
        UWVM2TEST_REQUIRE(bytecode_contains_fptr(bc1, exp_local_get_i32_after_i32_1));
        UWVM2TEST_REQUIRE(bytecode_contains_fptr(bc1, exp_memory_grow_i32));

        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_local_get_i64_fptr_from_tuple<Opt>(curr, tuple));
        }));
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_local_get_i32_fptr_from_tuple<Opt>(curr, tuple));
        }));
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_memory_grow_fptr_from_tuple<Opt>(curr, tuple));
        }));
        return 0;
    }
#endif
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_pending_flush_size_grow() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_pending_flush_size_grow_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_pending_flush_size_grow");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_pending_flush_size_grow();
    }
    catch(...)
    {
