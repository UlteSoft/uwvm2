...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_localget_nonzero_offset_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
        ...
        // f0: local.get addr ; i32.load offset=12 ; i32.const -5 ; i32.add
        {
        ...
        // f1: local.get addr ; i32.load offset=20 ; i32.const 0x00ff00ff ; i32.and
        {
            func_type ty{{k_val_i32}, {k_val_i32}};
            func_body fb{};
            auto& c = fb.code;
        ...
        // f2: local.get addr ; f32.load offset=4
        {
        ...
        // f3: local.get addr ; f64.load offset=8
        {
                                          ...
                                          ::uwvm2::object::memory::linear::native_memory_t const& mem) noexcept
    {
        ...
        auto const exp_f32_load_localget = optable::translate::get_uwvmint_f32_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple);
        auto const exp_f64_load_localget = optable::translate::get_uwvmint_f64_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple);
        ...
        UWVM2TEST_REQUIRE(bytecode_count_fptr(bc0, exp_i32_load_add_imm) == 1uz);
    ...
    [[nodiscard]] int check_byref_bytecode(compiled_module_t const& cm) noexcept
    {
        ...
        auto const exp_f64_load_plain = optable::translate::get_uwvmint_f64_load_fptr<Opt, ::std::byte const*, ::std::byte*, ::std::byte*>(curr);
    ...
    [[nodiscard]] int test_translate_memory_localget_nonzero_offset() noexcept
    {
        ...
        auto wasm = build_memory_localget_nonzero_offset_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_localget_nonzero_offset");
...
int main()
{
    try
    {
        return test_translate_memory_localget_nonzero_offset();
    }
    catch(...)
    {
