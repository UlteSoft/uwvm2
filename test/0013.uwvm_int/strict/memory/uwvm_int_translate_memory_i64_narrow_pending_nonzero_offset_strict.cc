...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_i64_narrow_pending_nonzero_offset_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
...

        {
            ...
            op(c, wasm_op::i64_const); i64(c, static_cast<::std::int64_t>(0x8002ull));
...

        {
            ...
            op(c, wasm_op::i64_const); i64(c, static_cast<::std::int64_t>(0x80000008ull));
...

        {
            ...
            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::i32_const); i32(c, 169);
    ...
    [[nodiscard]] int test_translate_memory_i64_narrow_pending_nonzero_offset() noexcept
    {
        ...
        auto wasm = build_memory_i64_narrow_pending_nonzero_offset_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_i64_narrow_pending_nonzero_offset");
...
int main()
{
    try
    {
        return test_translate_memory_i64_narrow_pending_nonzero_offset();
    }
    catch(...)
    {
