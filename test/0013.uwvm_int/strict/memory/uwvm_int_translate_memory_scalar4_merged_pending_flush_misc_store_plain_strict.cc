...
namespace
{
    ...
    [[nodiscard]] byte_vec pack_i32x2_f32(::std::int32_t a, ::std::int32_t b, float c)
    {
        byte_vec out(12);
    ...
    [[nodiscard]] byte_vec pack_i32x2_f64(::std::int32_t a, ::std::int32_t b, double c)
    {
        byte_vec out(16);
        ::std::memcpy(out.data(), ::std::addressof(a), 4);
        ::std::memcpy(out.data() + 4, ::std::addressof(b), 4);
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_pending_flush_misc_store_plain_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
        ...
        {
            func_type ty{{k_val_i32, k_val_i32, k_val_f32}, {k_val_f32}};
            func_body fb{};
            auto& c = fb.code;
            ...
            op(c, wasm_op::f32_store); u32(c, 2u); u32(c, 4u);
            op(c, wasm_op::drop);
            op(c, wasm_op::local_get); u32(c, 1u);
        ...
        {
            func_type ty{{k_val_i32, k_val_i32, k_val_f64}, {k_val_f64}};
            func_body fb{};
            auto& c = fb.code;
...

        {
            ...
            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::local_get); u32(c, 1u);
            op(c, wasm_op::i64_store16); u32(c, 1u); u32(c, 2u);
            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::i64_load16_u); u32(c, 1u); u32(c, 2u);
            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::i64_extend_i32_u);
            op(c, wasm_op::i64_add);
            op(c, wasm_op::end);
                                     ...
                                     ::uwvm2::object::memory::linear::native_memory_t const& mem) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_i64_store8_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));

        UWVM2TEST_REQUIRE(contains_local_get_i32(bc3));
        UWVM2TEST_REQUIRE(contains_local_get_i64(bc3));
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc3, optable::translate::get_uwvmint_i64_store16_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
    ...
    [[nodiscard]] int run_suite(compiled_module_t const& cm, runtime_module_t const& rt) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(load_i64(Runner::run(cm.local_funcs.index_unchecked(2),
                                              ...
                                              pack_i32_i64(128, static_cast<::std::int64_t>(0x1234abull)),
                                              nullptr,
                                              nullptr)
                                       .results) == 299ll);
        ...
        UWVM2TEST_REQUIRE(load_i64(Runner::run(cm.local_funcs.index_unchecked(3),
                                              ...
                                              pack_i32_i64(160, static_cast<::std::int64_t>(0x1beefull)),
                                              nullptr,
                                              nullptr)
                                       .results) == 49039ll);
        return 0;
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_pending_flush_misc_store_plain() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_pending_flush_misc_store_plain_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_pending_flush_misc_store_plain");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_pending_flush_misc_store_plain();
    }
    catch(...)
    {
