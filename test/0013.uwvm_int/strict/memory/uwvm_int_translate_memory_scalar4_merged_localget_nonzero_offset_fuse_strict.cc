...
namespace
{
    ...
    [[nodiscard]] byte_vec pack_f64_i32(double a, ::std::int32_t b)
    {
        byte_vec out(12);
        ::std::memcpy(out.data(), ::std::addressof(a), 8);
        ::std::memcpy(out.data() + 8, ::std::addressof(b), 4);
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_localget_nonzero_offset_fuse_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
        ...
        {
            func_type ty{{k_val_f64, k_val_i32}, {k_val_f64}};
            func_body fb{};
            auto& c = fb.code;
                                     ...
                                     ::uwvm2::object::memory::linear::native_memory_t const& mem) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(search_curr_i32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc0, optable::translate::get_uwvmint_i32_load_add_imm_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32<Opt>([&](auto curr) noexcept {
        ...
        UWVM2TEST_REQUIRE(search_curr_i32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc1, optable::translate::get_uwvmint_i32_load_and_imm_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc1, optable::translate::get_uwvmint_i32_load_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc1, optable::translate::get_uwvmint_i32_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));

        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_i64_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_i64_load_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_i64_load_localget_set_local_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));

        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc3,
                                          optable::translate::get_uwvmint_i64_load_localget_set_local_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc3, optable::translate::get_uwvmint_i64_load_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc3, optable::translate::get_uwvmint_i64_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!contains_any_i64_local_set<Opt>(bc3));

        UWVM2TEST_REQUIRE(search_curr_i32_f32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc4, optable::translate::get_uwvmint_f32_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32_f32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc4, optable::translate::get_uwvmint_f32_load_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
# if defined(UWVM_ENABLE_UWVM_INT_HEAVY_COMBINE_OPS)
        UWVM2TEST_REQUIRE(!search_curr_i32_f32<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc4, optable::translate::get_uwvmint_f32_load_local_plus_imm_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
# endif

        UWVM2TEST_REQUIRE(search_curr_i32_f64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc5, optable::translate::get_uwvmint_f64_load_localget_off_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        UWVM2TEST_REQUIRE(!search_curr_i32_f64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc5, optable::translate::get_uwvmint_f64_load_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
# if defined(UWVM_ENABLE_UWVM_INT_HEAVY_COMBINE_OPS)
        UWVM2TEST_REQUIRE(!search_curr_i32_f64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc5, optable::translate::get_uwvmint_f64_load_local_plus_imm_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
# endif
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_localget_nonzero_offset_fuse() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_localget_nonzero_offset_fuse_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_localget_nonzero_offset_fuse");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_localget_nonzero_offset_fuse();
    }
    catch(...)
    {
