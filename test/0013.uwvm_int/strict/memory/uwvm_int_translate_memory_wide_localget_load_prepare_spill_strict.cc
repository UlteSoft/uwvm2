...
namespace
{
    ...
    inline constexpr optable::uwvm_interpreter_translate_option_t k_test_tail_wide_localget_spill_opt{
        .is_tail_call = true,
    ...
    [[nodiscard]] byte_vec build_memory_wide_localget_load_prepare_spill_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
                                          ...
                                          bool expect_spill) noexcept
    {
        ...
        constexpr auto curr_i64 = make_curr_after_i64_pushes<Opt>(1uz);
        constexpr auto curr_f32 = make_curr_after_f32_pushes<Opt>(1uz);
        constexpr auto curr_f64 = make_curr_after_f64_pushes<Opt>(1uz);

        auto const exp_i64 = optable::translate::get_uwvmint_i64_load_localget_off_fptr_from_tuple<Opt>(curr_i64, mem, tuple);
    ...
    [[nodiscard]] int test_translate_memory_wide_localget_load_prepare_spill() noexcept
    {
        ...
        auto wasm = build_memory_wide_localget_load_prepare_spill_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_wide_localget_load_prepare_spill");
        ...
        static_assert(compiler::details::interpreter_tuple_has_no_holes<k_test_tail_wide_localget_spill_opt>());
        UWVM2TEST_REQUIRE(compile_check_and_run<k_test_tail_wide_localget_spill_opt>(rt, true, true) == 0);
        return 0;
    }
}  // namespace
...
int main()
{
    try
    {
        return test_translate_memory_wide_localget_load_prepare_spill();
    }
    catch(...)
    {
