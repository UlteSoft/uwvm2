...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_i64_narrow_store_local_plus_imm_no_fuse_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
...

        {
            ...
            op(c, wasm_op::i32_const); i32(c, 68);
...

        {
            ...
            op(c, wasm_op::i32_const); i32(c, 149);
            op(c, wasm_op::i64_load8_u); u32(c, 0u); u32(c, 0u);
            op(c, wasm_op::end);
            (void)mb.add_func(::std::move(ty), ::std::move(fb));
        }

        {
            ...
            op(c, wasm_op::i32_add);
            op(c, wasm_op::local_get); u32(c, 1u);
            op(c, wasm_op::i64_store16); u32(c, 1u); u32(c, 14u);

            op(c, wasm_op::i32_const); i32(c, 190);
            op(c, wasm_op::i64_load16_u); u32(c, 1u); u32(c, 0u);
            op(c, wasm_op::end);
            (void)mb.add_func(::std::move(ty), ::std::move(fb));
        }

        {
            ...
            op(c, wasm_op::i64_store8); u32(c, 0u); u32(c, 1u);
                                     ...
                                     ::uwvm2::object::memory::linear::native_memory_t const& mem) noexcept
    {
        ...
        auto require_store8 = [&](auto const& bc) noexcept -> int
        {
            ...
            UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_i32_add_fptr_from_tuple<Opt>(curr, tuple));
            }));
            UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_local_get_i64_fptr_from_tuple<Opt>(curr, tuple));
            }));
            UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_i64_store8_fptr_from_tuple<Opt>(curr, mem, tuple));
            }));
            UWVM2TEST_REQUIRE(!search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_i32_add_imm_localget_fptr_from_tuple<Opt>(curr, tuple));
            }));
            return 0;
        };

        auto require_store16 = [&](auto const& bc) noexcept -> int
        {
            UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_local_get_i32_fptr_from_tuple<Opt>(curr, tuple));
            }));
            ...
            UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_i64_store16_fptr_from_tuple<Opt>(curr, mem, tuple));
            }));
            UWVM2TEST_REQUIRE(!search_curr_i32_i64<Opt>([&](auto curr) noexcept {
                return bytecode_contains_fptr(bc, optable::translate::get_uwvmint_i32_add_imm_localget_fptr_from_tuple<Opt>(curr, tuple));
            }));
        ...
        UWVM2TEST_REQUIRE(require_store8(bc0) == 0);
        UWVM2TEST_REQUIRE(require_store16(bc1) == 0);
        UWVM2TEST_REQUIRE(require_store8(bc2) == 0);
        UWVM2TEST_REQUIRE(require_store16(bc3) == 0);
        UWVM2TEST_REQUIRE(require_store8(bc4) == 0);
        return 0;
    }
#endif
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_i64_narrow_store_local_plus_imm_no_fuse() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_i64_narrow_store_local_plus_imm_no_fuse_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_i64_narrow_store_local_plus_imm_no_fuse");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_i64_narrow_store_local_plus_imm_no_fuse();
    }
    catch(...)
    {
