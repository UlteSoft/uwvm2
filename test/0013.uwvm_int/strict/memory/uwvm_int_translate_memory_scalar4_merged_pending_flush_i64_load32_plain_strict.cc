...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_pending_flush_i64_load32_plain_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
...

        {
            ...
            op(c, wasm_op::i64_const); i64(c, static_cast<::std::int64_t>(0x80000010ull));
            op(c, wasm_op::i64_store32); u32(c, 2u); u32(c, 0u);

            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::local_get); u32(c, 1u);
            op(c, wasm_op::i64_load32_s); u32(c, 2u); u32(c, 4u);
...

        {
            ...
            op(c, wasm_op::i64_const); i64(c, static_cast<::std::int64_t>(0xF1234567ull));
            op(c, wasm_op::i64_store32); u32(c, 2u); u32(c, 0u);

            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::local_get); u32(c, 1u);
            op(c, wasm_op::i64_load32_u); u32(c, 2u); u32(c, 8u);
            op(c, wasm_op::local_set); u32(c, 2u);
            op(c, wasm_op::i64_extend_i32_s);
            op(c, wasm_op::local_get); u32(c, 2u);
            op(c, wasm_op::i64_add);
...

        {
            ...
            op(c, wasm_op::i64_const); i64(c, static_cast<::std::int64_t>(0x7ffffffeull));
            op(c, wasm_op::i64_store32); u32(c, 2u); u32(c, 0u);

            op(c, wasm_op::local_get); u32(c, 0u);
            op(c, wasm_op::local_get); u32(c, 1u);
            op(c, wasm_op::i64_load32_u); u32(c, 2u); u32(c, 12u);
            op(c, wasm_op::i64_add);
            op(c, wasm_op::end);
            (void)mb.add_func(::std::move(ty), ::std::move(fb));
        }
                                     ...
                                     ::uwvm2::object::memory::linear::native_memory_t const& mem) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc0, optable::translate::get_uwvmint_i64_load32_s_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        ...
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc1, optable::translate::get_uwvmint_i64_load32_u_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        ...
        UWVM2TEST_REQUIRE(search_curr_i32_i64<Opt>([&](auto curr) noexcept {
            return bytecode_contains_fptr(bc2, optable::translate::get_uwvmint_i64_load32_u_fptr_from_tuple<Opt>(curr, mem, tuple));
        }));
        return 0;
    }
#endif
    ...
    [[nodiscard]] int run_suite(compiled_module_t const& cm, runtime_module_t const& rt) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(load_i64(Runner::run(cm.local_funcs.index_unchecked(1),
                                              ...
                                              nullptr,
                                              nullptr)
                                       .results) == static_cast<::std::int64_t>(4045620605ull));
        ...
        UWVM2TEST_REQUIRE(load_i64(Runner::run(cm.local_funcs.index_unchecked(2),
                                              ...
                                              nullptr,
                                              nullptr)
                                       .results) == static_cast<::std::int64_t>(2147483655ull));
        return 0;
    }
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_pending_flush_i64_load32_plain() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_pending_flush_i64_load32_plain_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_pending_flush_i64_load32_plain");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_pending_flush_i64_load32_plain();
    }
    catch(...)
    {
