...
namespace
{
    ...
    [[nodiscard]] byte_vec build_memory_scalar4_merged_i64_load32_local_plus_imm_no_fuse_module()
    {
        module_builder mb{};
        mb.has_memory = true;
        mb.memory_min = 1u;
    ...
    [[nodiscard]] int run_suite(compiled_module_t const& cm, runtime_module_t const& rt) noexcept
    {
        ...
        UWVM2TEST_REQUIRE(load_i64(Runner::run(cm.local_funcs.index_unchecked(1),
                                              ...
                                              nullptr,
                                              nullptr)
                                       .results) == static_cast<::std::int64_t>(0xF1234567ull));
    ...
    [[nodiscard]] int test_translate_memory_scalar4_merged_i64_load32_local_plus_imm_no_fuse() noexcept
    {
        ...
        auto wasm = build_memory_scalar4_merged_i64_load32_local_plus_imm_no_fuse_module();
        auto prep = prepare_runtime_from_wasm(wasm, u8"uwvm2test_memory_scalar4_merged_i64_load32_local_plus_imm_no_fuse");
...
int main()
{
    try
    {
        return test_translate_memory_scalar4_merged_i64_load32_local_plus_imm_no_fuse();
    }
    catch(...)
    {
