...
consteval uwvm_int_optable::uwvm_interpreter_stacktop_remain_size_t remain_i32_only() noexcept
{
    ...
    constexpr uwvm_int_optable::uwvm_interpreter_stacktop_currpos_t curr{.i32_stack_top_curr_pos = 4uz,
    ...
    return uwvm_int_optable::get_remain_size_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_i32, wasm_i32, wasm_i32>>(op, sp, local_base, r3, r4, r5);
}
...
int main()
{
    ...
    // Case 1: i32 stacktop only, [3,6), curr=4 => 4,5,3 order.
    {
        ...
        auto const vals =
            uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_i32, wasm_i32, wasm_i32>>(op, sp, local_base, r3, r4, r5);
    ...
    // Case 2: i32 stacktop exhausted => fallback to operand stack.
    {
        ...
        auto const vals =
            uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_i32, wasm_i32, wasm_i32, wasm_i32>>(op, sp, local_base, r3, r4, r5);

        if(::fast_io::get<0>(vals) != 22 || ::fast_io::get<1>(vals) != 33 || ::fast_io::get<2>(vals) != 11 || ::fast_io::get<3>(vals) != 44) { return 3; }
        if(sp != mem) { return 4; }
    }
    ...
    // Case 3: i32/i64 stacktop merge [3,5), curr=3 => i32 from 3, i64 from 4.
    {
        ...
        auto const vals = uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_i32, wasm_i64>>(op, sp, local_base, s3, s4);
        ...
        s3.i32 = 111;
        s4.i64 = 222;
        auto const vals2 = uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_i32, wasm_i64, wasm_i32>>(op, sp, local_base, s3, s4);
    ...
    // Case 4: f32/f64/v128 stacktop merge [3,5), curr=4 => f32 from 4, f64 from 3.
    {
        ...
        constexpr uwvm_int_optable::uwvm_interpreter_stacktop_currpos_t curr{.i32_stack_top_curr_pos = SIZE_MAX,
                                                                             .i64_stack_top_curr_pos = SIZE_MAX,
        ...
        auto const vals = uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_f32, wasm_f64>>(op, sp, local_base, f3, f4);
        ...
        auto const vals2 = uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_f32, wasm_f64, wasm_f32>>(op, sp, local_base, f3, f4);
    ...
    // Case 6: no stacktop => all from operand stack (cache path).
    {
        ...
        auto const vals =
            uwvm_int_optable::get_vals_from_operand_stack<opt, curr, ::fast_io::tuple<wasm_i32, wasm_i64, wasm_f32, wasm_f64, wasm_v128>>(op, sp, local_base);
        if(::fast_io::get<0>(vals) != 6 || ::fast_io::get<1>(vals) != 7 || ::fast_io::get<2>(vals) != 8.0f || ::fast_io::get<3>(vals) != 9.0) { return 13; }
