...
namespace
{
    ...
    [[nodiscard]] int compile_and_run(byte_vec const& wasm, ::uwvm2::utils::container::u8string_view module_name, lazy_validation_mode_t validation_mode)
    {
    ...
    [[nodiscard]] int test_lazy_scheduler()
    {
        ...
        UWVM2TEST_REQUIRE(compile_and_run<opt>(wasm, u8"uwvm2test_lazy_scheduler_validate", lazy_validation_mode_t::validate_on_lazy_compile) == 0);
        UWVM2TEST_REQUIRE(compile_and_run<opt>(wasm, u8"uwvm2test_lazy_scheduler_assume", lazy_validation_mode_t::assume_full_code_verified) == 0);
