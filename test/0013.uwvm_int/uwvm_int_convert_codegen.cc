...
[[gnu::noinline]] void codegen_i64_extend_i32_u_cached(T0 ip, T1 sp, T2 local_base, slot_scalar s3, slot_scalar s4)
{
    ...
    optable::uwvmint_i64_extend_i32_u<opt, 3uz, T0, T1, T2, slot_scalar, slot_scalar>(ip, sp, local_base, s3, s4);
}
...
[[gnu::noinline]] void codegen_i32_trunc_f64_s_cached(T0 ip, T1 sp, T2 local_base, slot_scalar s3, slot_scalar s4)
{
    ...
    optable::uwvmint_i32_trunc_f64_s<opt, 3uz, T0, T1, T2, slot_scalar, slot_scalar>(ip, sp, local_base, s3, s4);
}
...
[[gnu::noinline]] void codegen_f64_promote_f32_cached(T0 ip, T1 sp, T2 local_base, slot_scalar s3, slot_scalar s4)
{
    ...
    optable::uwvmint_f64_promote_f32<opt, 3uz, T0, T1, T2, slot_scalar, slot_scalar>(ip, sp, local_base, s3, s4);
}
...
[[gnu::noinline]] void codegen_i32_reinterpret_f32_cached(T0 ip, T1 sp, T2 local_base, slot_scalar s3, slot_scalar s4)
{
    ...
    optable::uwvmint_i32_reinterpret_f32<opt, 3uz, T0, T1, T2, slot_scalar, slot_scalar>(ip, sp, local_base, s3, s4);
}
...
{
    constexpr optable::uwvm_interpreter_translate_option_t opt{.is_tail_call = true};
    optable::uwvmint_i32_trunc_f64_s<opt, 0uz, T0, T1, T2>(ip, sp, local_base);
}
