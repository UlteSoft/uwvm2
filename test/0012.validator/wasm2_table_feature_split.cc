...
/**
 * @brief       WebAssembly 2.0 table feature split validation
 * @details     Separates reference-types, table-instructions, and multiple-tables at parser and code-validator extension points.
 * @author      MacroModel
 * @version     2.0.0
 * @date        2026-07-11
...
int main()
{
    ...
    static_assert(::std::same_as<::uwvm2::validation::concepts::code_version_type_t<wasm1, wasm1p1>,
                                 wasm1p1_code_version>);
    static_assert(::uwvm2::validation::concepts::can_validate_code<wasm1p1_code_version, wasm1, wasm1p1>);
    static_assert(::uwvm2::validation::concepts::can_validate_code_with_parameter<wasm1p1_code_version, wasm1, wasm1p1>);
    static_assert(::std::same_as<::uwvm2::validation::concepts::code_version_type_t<wasm1, wasm1p1, wasm2>,
                                 wasm2_code_version>);
    static_assert(::uwvm2::validation::concepts::can_validate_code<wasm2_code_version, wasm1, wasm1p1, wasm2>);
    ...
    validate(table_zero, multiple_tables_off, true, feature_kind::multiple_tables);
    expect_parse_rejection(table_get_one_module, multiple_tables_off);

    auto const table_one{parse(table_get_one_module, defaults)};
    validate(table_one, defaults, true, feature_kind::multiple_tables);
