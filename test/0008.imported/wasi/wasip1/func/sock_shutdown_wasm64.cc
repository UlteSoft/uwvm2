...
# include <uwvm2/imported/wasi/wasip1/func/sock_shutdown_wasm64.h>
...
int main()
{
    ...
    using ::uwvm2::imported::wasi::wasip1::abi::sdflags_wasm64_t;
    ...
    {
        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::sock_shutdown_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(-1), static_cast<sdflags_wasm64_t>(1));
        if(ret != errno_wasm64_t::ebadf)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected ebadf for negative fd");
    ...
    // Case 1: closed descriptor (close_pos != SIZE_MAX) -> ebadf
    {
        ...
        if(ret != errno_wasm64_t::ebadf)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected ebadf for closed descriptor");
            ::fast_io::fast_terminate();
        }
    }
    ...
    // Case 2: missing rights -> enotcapable
    {
        ...
        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::sock_shutdown_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(2), static_cast<sdflags_wasm64_t>(1));
        if(ret != errno_wasm64_t::enotcapable)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected enotcapable for missing right_sock_shutdown");
            ::fast_io::fast_terminate();
        }
    }
    ...
    // Case 3: invalid how (0) -> einval
    {
        ...
        fde.close_pos = static_cast<::std::size_t>(-1);
        fde.rights_base = rights_wasm64_t::right_sock_shutdown;
        fde.rights_inherit = rights_wasm64_t::right_sock_shutdown;

        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::sock_shutdown_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(0), static_cast<sdflags_wasm64_t>(0));
        if(ret != errno_wasm64_t::einval)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected einval for zero sdflags");
            ::fast_io::fast_terminate();
        }
    }
    ...
    // Case 4: invalid how (unknown bits) -> einval
    {
        ...
        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::sock_shutdown_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(0), static_cast<sdflags_wasm64_t>(0x04));
        if(ret != errno_wasm64_t::einval)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected einval for invalid sdflags bits");
            ::fast_io::fast_terminate();
        }
    }
    ...
    // Case 5: descriptor type is dir -> enotsock
    {
        ...
        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::sock_shutdown_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(0), static_cast<sdflags_wasm64_t>(1));
        if(ret != errno_wasm64_t::enotsock)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected enotsock for directory descriptor");
            ::fast_io::fast_terminate();
        }
    }
...
#  if !defined(_WIN32)
    // Case 6: real TCP shutdown on loopback (POSIX)
    {
        ...
        if(listen_fd < 0)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: failed to create listening socket");
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: bind failed");
            ::close(listen_fd);
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: getsockname failed");
            ::close(listen_fd);
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: listen failed");
            ::close(listen_fd);
            ::fast_io::fast_terminate();
        }
        ...
        if(client_fd < 0)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: failed to create client socket");
            ::close(listen_fd);
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: connect failed");
            ::close(client_fd);
            ::close(listen_fd);
            ::fast_io::fast_terminate();
        }
        ...
        if(accepted_fd < 0)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: accept failed");
            ::close(client_fd);
            ::close(listen_fd);
            ::fast_io::fast_terminate();
        }
        ...
        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::sock_shutdown_wasm64(env2, static_cast<wasi_posix_fd_wasm64_t>(1), static_cast<sdflags_wasm64_t>(2));
        if(ret != errno_wasm64_t::esuccess)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64: expected esuccess for real TCP shutdown");
            ::close(client_fd);
            ::fast_io::fast_terminate();
        }
...
#  elif defined(UWVM_HAS_NATIVE_WIN32_WS2)
    // Case 6: real TCP shutdown on loopback (WinSock2 / Win32 socket type)
    {
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): WSAStartup failed");
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): failed to create listening socket");
            ::WSACleanup();
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): bind failed");
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): getsockname failed");
            ::closesocket(listen_socket);
            ::WSACleanup();
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): listen failed");
            ::closesocket(listen_socket);
            ::WSACleanup();
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): failed to create client socket");
            ::closesocket(listen_socket);
            ::WSACleanup();
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): connect failed");
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): accept failed");
            ::closesocket(client_socket);
            ::closesocket(listen_socket);
            ::WSACleanup();
            ::fast_io::fast_terminate();
        ...
        if(ret != errno_wasm64_t::esuccess)
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_shutdown_wasm64(win32): expected esuccess for real TCP shutdown");
            ::closesocket(client_socket);
