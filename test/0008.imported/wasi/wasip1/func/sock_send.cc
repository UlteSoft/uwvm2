...
int main()
{
    ...
    // Case 4: zero iovs_len -> esuccess, nsent=0
    {
        ...
        auto const n0 =
            ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm32<wasi_size_t>(memory, NSENT_PTR);
...
# if !defined(_WIN32)
    // Case 6: real TCP send on loopback (POSIX)
    {
        ...
        auto const nsent2 =
            ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm32<wasi_size_t>(memory2, NSENT2_PTR);
