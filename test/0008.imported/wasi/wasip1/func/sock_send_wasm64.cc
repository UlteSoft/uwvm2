...
# elif defined(_WIN32) && !defined(__CYGWIN__)
    // Case 6: real TCP send on loopback (WinSock2 / Win32 socket type)
    {
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_send_wasm64(win32): WSAStartup failed");
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_send_wasm64(win32): listen failed");
            ::closesocket(listen_socket);
            ::WSACleanup();
            ::fast_io::fast_terminate();
        }
        ...
        {
            ::fast_io::io::perrln(::fast_io::u8err(), u8"sock_send_wasm64(win32): accept failed");
            ::closesocket(client_socket);
            ::closesocket(listen_socket);
            ::WSACleanup();
            ::fast_io::fast_terminate();
