...
#include <uwvm2/imported/wasi/wasip1/func/random_get.h>
...
int main()
{
    ...
    // Case 1: non-zero buffer should be filled, guards must remain unchanged
    {
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::random_get(env, buf, static_cast<wasi_size_t>(BUF_LEN));
        if(ret != ::uwvm2::imported::wasi::wasip1::abi::errno_t::esuccess) { ::fast_io::fast_terminate(); }
        ...
        // Buffer should not be all zeros after random_get
