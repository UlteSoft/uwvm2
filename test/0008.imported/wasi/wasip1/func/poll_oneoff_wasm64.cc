...
int main()
{
    ...
    // Case 0: single clock subscription should behave as sleep
    {
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::poll_oneoff_wasm64(env, P_SUBS, P_EVENTS, static_cast<wasi_size_wasm64_t>(1u), P_NEVENTS);
        ...
        auto const nevents = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_size_wasm64_t>(memory, P_NEVENTS);
        if(nevents != static_cast<wasi_size_wasm64_t>(1u))
        {
    ...
    {
        wasi_subscription_wasm64_t sub{};
        sub.userdata = static_cast<userdata_wasm64_t>(static_cast<::std::uint64_t>(0xA1A2A3A4uLL));
        sub.u.tag = eventtype_wasm64_t::eventtype_fd_read;
        sub.u.u.fd_readwrite.file_descriptor = static_cast<fd_wasm64_t>(12345);
        ...
        if(evt.userdata != sub.userdata || evt.type != eventtype_wasm64_t::eventtype_fd_read ||
           evt.error != ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::ebadf || evt.u.fd_readwrite.nbytes != static_cast<filesize_wasm64_t>(0u) ||
           evt.u.fd_readwrite.flags != static_cast<eventrwflags_wasm64_t>(0u))
        {
            ::fast_io::perrln(static_cast<unsigned>(__LINE__));
            ::fast_io::fast_terminate();
        }
    ...
    // Case 3: fd_write subscription on FD without poll rights -> enotcapable
    {
        ...
        fd.rights_inherit = static_cast<rights_wasm64_t>(0);

        wasi_subscription_wasm64_t sub{};
        sub.userdata = static_cast<userdata_wasm64_t>(static_cast<::std::uint64_t>(0xB1B2B3B4uLL));
        sub.u.tag = eventtype_wasm64_t::eventtype_fd_write;
        sub.u.u.fd_readwrite.file_descriptor = static_cast<fd_wasm64_t>(3);
        ...
        if(evt.userdata != sub.userdata || evt.type != eventtype_wasm64_t::eventtype_fd_write ||
           evt.error != ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::enotcapable || evt.u.fd_readwrite.nbytes != static_cast<filesize_wasm64_t>(0u) ||
           evt.u.fd_readwrite.flags != static_cast<eventrwflags_wasm64_t>(0u))
        {
            ::fast_io::perrln(static_cast<unsigned>(__LINE__));
            ::fast_io::fast_terminate();
    ...
    // Case 5: two fd subscriptions (invalid fd and no-rights fd) -> two events
    {
        ...
        fd3.rights_base = static_cast<rights_wasm64_t>(0);
        fd3.rights_inherit = static_cast<rights_wasm64_t>(0);

        wasi_subscription_wasm64_t subs[2]{};

        subs[0].userdata = static_cast<userdata_wasm64_t>(static_cast<::std::uint64_t>(0xC1C2C3C4uLL));
        subs[0].u.tag = eventtype_wasm64_t::eventtype_fd_read;
        subs[0].u.u.fd_readwrite.file_descriptor = static_cast<fd_wasm64_t>(12345);

        subs[1].userdata = static_cast<userdata_wasm64_t>(static_cast<::std::uint64_t>(0xD1D2D3D4uLL));
        subs[1].u.tag = eventtype_wasm64_t::eventtype_fd_write;
        subs[1].u.u.fd_readwrite.file_descriptor = static_cast<fd_wasm64_t>(3);
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::poll_oneoff_wasm64(env, P_SUBS, P_EVENTS, static_cast<wasi_size_wasm64_t>(2u), P_NEVENTS);
        if(ret != ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::esuccess)
        {
            ::fast_io::perrln(static_cast<unsigned>(__LINE__), " ", static_cast<unsigned>(ret));
            ::fast_io::fast_terminate();
        ...
        auto const nevents = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_size_wasm64_t>(memory, P_NEVENTS);
        if(nevents != static_cast<wasi_size_wasm64_t>(2u))
        {
            ::fast_io::perrln(static_cast<unsigned>(__LINE__), " ", static_cast<unsigned>(nevents));
            ::fast_io::fast_terminate();
        }

        wasi_event_wasm64_t evts[2]{};
        ::uwvm2::imported::wasi::wasip1::memory::read_all_from_memory_wasm64(memory,
                                                                             P_EVENTS,
        ...
        auto const userdata_fd_read{static_cast<userdata_wasm64_t>(static_cast<::std::uint64_t>(0xC1C2C3C4uLL))};
        auto const userdata_fd_write{static_cast<userdata_wasm64_t>(static_cast<::std::uint64_t>(0xD1D2D3D4uLL))};

        auto const matches = [](wasi_event_wasm64_t const& evt,
                                userdata_wasm64_t expected_userdata,
                                ::uwvm2::imported::wasi::wasip1::abi::eventtype_wasm64_t expected_type,
                                ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t expected_error) noexcept
        {
            return evt.userdata == expected_userdata && evt.type == expected_type && evt.error == expected_error &&
                   evt.u.fd_readwrite.nbytes == static_cast<filesize_wasm64_t>(0u) && evt.u.fd_readwrite.flags == static_cast<eventrwflags_wasm64_t>(0u);
        };

        if(matches(evt0, userdata_fd_read, eventtype_wasm64_t::eventtype_fd_read, ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::ebadf) ||
           matches(evt1, userdata_fd_read, eventtype_wasm64_t::eventtype_fd_read, ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::ebadf))
        {
            got_fd_read = true;
        }

        if(matches(evt0, userdata_fd_write, eventtype_wasm64_t::eventtype_fd_write, ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::enotcapable) ||
           matches(evt1, userdata_fd_write, eventtype_wasm64_t::eventtype_fd_write, ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::enotcapable))
        {
            got_fd_write = true;
        }
