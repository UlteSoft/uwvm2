...
inline static void wasi_scenario_args(native_memory_t& memory, wasip1_environment<native_memory_t>& env, ::std::size_t base_off)
{
    ...
    auto const got_argc =
        ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_size_wasm64_t>(memory, argc_ptr);
    ...
    {
        auto const p0 = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_void_ptr_wasm64_t>(
            memory,
            argv_ptr);
...
inline static void wasi_scenario_environ(native_memory_t& memory, wasip1_environment<native_memory_t>& env, ::std::size_t base_off)
{
    ...
    auto const got_envc =
        ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_size_wasm64_t>(memory, envc_ptr);
    ...
    {
        auto const ptr_off = static_cast<wasi_void_ptr_wasm64_t>(
            env_ptr + static_cast<wasi_void_ptr_wasm64_t>(i * sizeof(wasi_void_ptr_wasm64_t)));
        auto const p = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_void_ptr_wasm64_t>(
            memory,
            ptr_off);
...
inline static void wasi_scenario_fd_io(native_memory_t& memory,
                                       ...
                                       ::std::size_t base_off)
{
    ...
    auto const ret_w = ::uwvm2::imported::wasi::wasip1::func::fd_write_wasm64(
        env,
        fd,
        iovs_ptr,
    ...
    auto const ret_r = ::uwvm2::imported::wasi::wasip1::func::fd_pread_wasm64(
        env,
        fd,
        riovs_ptr,
...
inline static void wasi_scenario_fd_stat(native_memory_t& memory,
                                         wasip1_environment<native_memory_t>& env,
                                         wasi_posix_fd_wasm64_t fd,
                                         ::std::size_t base_off)
{
    ...
    auto const ft = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<
        ::std::underlying_type_t<filetype_wasm64_t>>(memory, static_cast<wasi_void_ptr_wasm64_t>(stat_ptr + 16u));
    if(ft != static_cast<::std::underlying_type_t<filetype_wasm64_t>>(filetype_wasm64_t::filetype_regular_file)) [[unlikely]]
    {
        ::fast_io::fast_terminate();
    }
...
inline static void wasi_scenario_dir(native_memory_t& memory,
                                     wasip1_environment<native_memory_t>& env,
                                     ...
                                     ::std::size_t base_off)
{
    ...
    auto const ret_create = ::uwvm2::imported::wasi::wasip1::func::path_create_directory_wasm64(
        env,
        dirfd,
        path_ptr,
    ...
    auto const ret_pfs = ::uwvm2::imported::wasi::wasip1::func::path_filestat_get_wasm64(
        env,
        dirfd,
    ...
    auto const ret_rm = ::uwvm2::imported::wasi::wasip1::func::path_remove_directory_wasm64(
        env,
        dirfd,
        path_ptr,
        static_cast<wasi_size_wasm64_t>(name.size()));
    if(ret_rm != errno_wasm64_t::esuccess && ret_rm != errno_wasm64_t::enoent) [[unlikely]]
    {
        ::fast_io::fast_terminate();
    }
}
                                                 ...
                                                 ::std::size_t base_off)
{
    ...
    auto const ret_po = ::uwvm2::imported::wasi::wasip1::func::path_open_wasm64(
        env,
        dirfd,
        static_cast<lookupflags_wasm64_t>(0),
        path_ptr,
    ...
    auto const opened_fd = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<wasi_posix_fd_wasm64_t>(
        memory,
        fd_out_ptr);
    ...
    auto const ret_rd = ::uwvm2::imported::wasi::wasip1::func::fd_read_wasm64(
        env,
        opened_fd,
        iovs_ptr,
        static_cast<wasi_size_wasm64_t>(1u),
...
inline static void wasi_scenario_clock(native_memory_t& memory, wasip1_environment<native_memory_t>& env, ::std::size_t base_off)
{
    ...
    auto const ret_res =
        ::uwvm2::imported::wasi::wasip1::func::clock_res_get_wasm64(env, clockid_wasm64_t::clock_monotonic, res_ptr);
    if(ret_res != errno_wasm64_t::esuccess) [[unlikely]] { ::fast_io::fast_terminate(); }

    auto const got_ns = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<
        ::std::underlying_type_t<timestamp_wasm64_t>>(memory, res_ptr);
    ...
    auto const ret_t1 = ::uwvm2::imported::wasi::wasip1::func::clock_time_get_wasm64(
        env,
    ...
    auto const t1 = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<
        ::std::underlying_type_t<timestamp_wasm64_t>>(memory, time_ptr);

    auto const ret_t2 = ::uwvm2::imported::wasi::wasip1::func::clock_time_get_wasm64(
        env,
        clockid_wasm64_t::clock_monotonic,
    ...
    auto const t2 = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<
        ::std::underlying_type_t<timestamp_wasm64_t>>(memory, time_ptr);
...
int main()
{
    ...
    for(unsigned tid = 0; tid < thread_count; ++tid)
    {
        ...
        fde.wasi_fd.ptr->wasi_fd_storage.storage.file_fd.file =
            ::fast_io::native_file{u8"wasi_hybrid_fd.tmp",
                                   ::fast_io::open_mode::out | ::fast_io::open_mode::in | ::fast_io::open_mode::trunc |
    ...
    try
    {
        ::fast_io::native_file f{u8"wasi_hybrid_src.txt",
                                 ::fast_io::open_mode::out | ::fast_io::open_mode::trunc | ::fast_io::open_mode::creat};
        char const data[] = "ABCDEF";
        ::fast_io::operations::write_all_bytes(f,
                                               reinterpret_cast<::std::byte const*>(data),
                                               reinterpret_cast<::std::byte const*>(data) + (sizeof(data) - 1u));
    }
