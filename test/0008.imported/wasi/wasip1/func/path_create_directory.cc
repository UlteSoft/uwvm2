...
int main()
{
    ...
    // Case 3: absolute path -> enotcapable
    {
        ...
        if(ret != errno_t::enotcapable)
        {
            ::fast_io::io::perrln("error: pcd32 Case 3 expected enotcapable. ", static_cast<unsigned>(ret));
            ::fast_io::fast_terminate();
        }
    }
    ...
    // Case 16: symlink escapes root -> enotcapable
    {
        ...
        if(ret != errno_t::enotcapable)
        {
            ::fast_io::io::perrln("error: pcd32 Case 16 expected enotcapable. ", static_cast<unsigned>(ret));
            ::fast_io::fast_terminate();
        }
    ...
    // Case 18: symlink to absolute path (e.g., /etc) -> enotcapable
    {
        ...
        if(ret != errno_t::enotcapable)
        {
            ::fast_io::io::perrln("error: pcd32 Case 18 expected enotcapable. ", static_cast<unsigned>(ret));
            ::fast_io::fast_terminate();
        }
    ...
    // Case 21: permission boundary on parent dir -> eacces/enotcapable (only posix)
...

    {
        ...
        if(!(ret == errno_t::eacces || ret == errno_t::enotcapable))
        {
            ::fast_io::io::perrln("error: pcd32 Case 21 expected eacces/enotcapable. ", static_cast<unsigned>(ret));
            ::fast_io::fast_terminate();
        }
