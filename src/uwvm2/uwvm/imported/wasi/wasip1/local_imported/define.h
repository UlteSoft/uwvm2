...
/// @todo Wrap all function definitions in wasip1 into a local_imported module.
/// @note struct wasip1_local_imported_module_t{}; // meet concept ::uwvm2::uwvm::wasm::type::is_local_imported_module
