...
#  endif
                                                            ...
                                                            ::uwvm2::utils::cmdline::parameter_parsing_results* para_end) noexcept
    {
        ...
        if(auto const ret{wasip1_group_details::validate_group_arg(::uwvm2::uwvm::cmdline::params::wasip1_group_add_module, group_arg, para_end, group_name)};
        ...
        if(!::uwvm2::uwvm::imported::wasi::wasip1::storage::try_add_wasip1_module_to_named_group(module_name, group_index)) [[unlikely]]
        {
            return wasip1_module_details::print_usage_error(::uwvm2::uwvm::cmdline::params::wasip1_group_add_module,
                                                            u8"One module can only be configured for one WASI Preview 1 group.");
        }

        group_arg->type = wasip1_group_details::parameter_type::occupied_arg;
        module_arg->type = wasip1_group_details::parameter_type::occupied_arg;
