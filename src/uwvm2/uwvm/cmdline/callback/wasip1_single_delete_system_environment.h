...
#  endif
        ::uwvm2::utils::cmdline::parameter_return_type wasip1_single_delete_system_environment_callback(
            [[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results * para_begin,
            ::uwvm2::utils::cmdline::parameter_parsing_results * para_curr,
            ::uwvm2::utils::cmdline::parameter_parsing_results * para_end) noexcept
    {
        return wasip1_single_details::apply_action(::uwvm2::uwvm::cmdline::params::wasip1_single_delete_system_environment,
                                                   para_curr,
                                                   para_end,
