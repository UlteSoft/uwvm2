...
UWVM_MODULE_EXPORT namespace uwvm2::uwvm::cmdline::params::details
{
    ...
    UWVM_GNU_COLD inline constexpr ::uwvm2::utils::cmdline::parameter_return_type log_convert_warn_to_fatal_callback(
        ...
        ::uwvm2::utils::cmdline::parameter_parsing_results * para_end) noexcept
    {
        ...
        if(auto currp1_str{currp1->str}; currp1_str == u8"all")
        {
            ...
            ::uwvm2::uwvm::io::week_symbol_warning_fatal = true;
#endif
...
#endif
#ifdef UWVM_SUPPORT_WEEK_SYMBOL
        else if(currp1_str == u8"week-symbol") { ::uwvm2::uwvm::io::week_symbol_warning_fatal = true; }
#endif
