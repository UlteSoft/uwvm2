...
#  endif
        ::uwvm2::utils::cmdline::parameter_return_type wasip1_single_add_environment_callback([[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results* para_begin,
