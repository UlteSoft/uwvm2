...
# endif
            ...
            ::uwvm2::utils::cmdline::parameter_parsing_results * para_end) noexcept
    {
        ...
        ::std::size_t max_size{};
        auto const [next, err]{::fast_io::parse_by_scan(currp1_str.cbegin(), currp1_str.cend(), max_size)};
        ...
        ::uwvm2::uwvm::runtime::runtime_mode::global_runtime_uwvm_int_loop_unwind_max_size = max_size;
