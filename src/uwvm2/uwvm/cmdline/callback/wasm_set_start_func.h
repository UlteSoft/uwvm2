...
UWVM_MODULE_EXPORT namespace uwvm2::uwvm::cmdline::params::details
{
    ...
    [[nodiscard]] inline constexpr bool wasm_set_start_func_parse_u64(::uwvm2::utils::container::u8string_view str) noexcept
    {
    ...
    [[nodiscard]] inline constexpr bool wasm_set_start_func_parse_f64(::uwvm2::utils::container::u8string_view str) noexcept
    {
    ...
    [[nodiscard]] inline constexpr bool wasm_set_start_func_is_numeric_token(::uwvm2::utils::container::u8string_view str) noexcept
    {
        if(str.empty()) [[unlikely]] { return false; }
        if(wasm_set_start_func_parse_i64(str) || wasm_set_start_func_parse_u64(str)) { return true; }
