...
#  endif
        ::uwvm2::utils::cmdline::parameter_return_type wasip1_group_enable_utf8_check_callback([[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results* para_begin,
