...
#  endif
        ::uwvm2::utils::cmdline::parameter_return_type wasip1_global_set_fd_limit_callback([[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results *
                                                                                        para_begin,
                                                                                    ...
                                                                                    ::uwvm2::utils::cmdline::parameter_parsing_results * para_end) noexcept
    {
        ...
        if(currp1 == para_end || currp1->type != ::uwvm2::utils::cmdline::parameter_parsing_results_type::arg) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::uwvm2::uwvm::io::u8log_output,
                                ...
                                u8"Usage: ",
                                ::uwvm2::utils::cmdline::print_usage(::uwvm2::uwvm::cmdline::params::wasip1_global_set_fd_limit),
