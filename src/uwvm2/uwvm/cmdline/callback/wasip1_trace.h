...
# if defined(UWVM_IMPORT_WASI_WASIP1)
    namespace wasip1_trace_details
    {
        ...
        [[nodiscard]] inline parameter_return_type print_usage_error(::uwvm2::utils::container::u8string_view msg) noexcept
        {
            ::fast_io::io::perr(::uwvm2::uwvm::io::u8log_output,
                                ...
                                msg,
                                u8" Usage: ",
                                ::uwvm2::utils::cmdline::print_usage(::uwvm2::uwvm::cmdline::params::wasip1_trace),
                                u8"\n\n");
...
#  endif
        ::uwvm2::utils::cmdline::parameter_return_type wasip1_trace_callback([[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results* para_begin,
                                                                             ...
                                                                             ::uwvm2::utils::cmdline::parameter_parsing_results* para_end) noexcept
    {
        ...
        {
            return wasip1_trace_details::print_usage_error(u8"Missing trace output target.");
        }

        target_arg->type = ::uwvm2::utils::cmdline::parameter_parsing_results_type::occupied_arg;
        return wasip1_trace_details::apply_trace_target_to_default_env(target_arg, para_end);
    }
