...
#  endif
        ::uwvm2::utils::cmdline::parameter_return_type wasip1_global_socket_tcp_listen_callback([[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results *
                                                                                             para_begin,
                                                                                         ...
                                                                                         ::uwvm2::utils::cmdline::parameter_parsing_results * para_end) noexcept
    {
        ...
        if(currp1 == para_end || currp1->type != ::uwvm2::utils::cmdline::parameter_parsing_results_type::arg) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::uwvm2::uwvm::io::u8log_output,
                                ...
                                u8"Usage: ",
                                ::uwvm2::utils::cmdline::print_usage(::uwvm2::uwvm::cmdline::params::wasip1_global_socket_tcp_listen),
...
#  if defined(UWVM_SUPPORT_UNIX_PATH_SOCKET)
        if(currp2_str == u8"unix")
        {
            ...
            if(currp3 != para_end && currp3->type == ::uwvm2::utils::cmdline::parameter_parsing_results_type::arg) [[unlikely]]
            {
                ...
                // When currp3 is arg, it uses the Unix path format.
