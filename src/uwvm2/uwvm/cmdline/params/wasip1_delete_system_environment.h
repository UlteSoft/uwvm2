...
# if defined(UWVM_IMPORT_WASI_WASIP1)
    ...
    namespace details
    {
        inline constexpr ::uwvm2::utils::container::u8string_view wasip1_delete_system_environment_alias{u8"-I1delsysenv"};
...
#  endif
            ...
            wasip1_delete_system_environment_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_delete_system_environment{
        ...
        .describe{
            u8"Delete a host env var from the inherited WASI Preview 1 env (ignored with --wasip1-noinherit-system-environment; overridden by --wasip1-add-environment)."},
        .usage{u8"<env:str>"},
