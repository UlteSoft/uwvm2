...
UWVM_MODULE_EXPORT namespace uwvm2::uwvm::cmdline::params
{
    ...
    namespace details
    {
        inline constexpr ::uwvm2::utils::container::u8string_view runtime_tiered_alias{u8"-Rtiered"};
# if defined(UWVM_MODULE)
        extern "C++"
# else
        inline constexpr
# endif
            ::uwvm2::utils::cmdline::parameter_return_type runtime_tiered_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
# endif
    inline constexpr ::uwvm2::utils::cmdline::parameter runtime_tiered{
        ...
        .describe{u8"Shortcut for lazy compile with the tiered uwvm interpreter + LLVM JIT backend (DEFAULT)."},
