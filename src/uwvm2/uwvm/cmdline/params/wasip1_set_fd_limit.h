...
#  else
        inline constexpr
#  endif
            ::uwvm2::utils::cmdline::parameter_return_type wasip1_set_fd_limit_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_set_fd_limit{
        ...
        .describe{u8"Set the WASI Preview 1 file descriptor limit (0 = maximum)."},
