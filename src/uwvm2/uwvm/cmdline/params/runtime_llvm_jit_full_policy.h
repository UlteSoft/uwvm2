...
# else
        inline constexpr
# endif
            ::uwvm2::utils::cmdline::parameter_return_type runtime_llvm_jit_full_policy_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
# endif
    inline constexpr ::uwvm2::utils::cmdline::parameter runtime_llvm_jit_full_policy{
        ...
        .is_exist{::std::addressof(::uwvm2::uwvm::runtime::runtime_mode::runtime_llvm_jit_full_policy_existed)},
