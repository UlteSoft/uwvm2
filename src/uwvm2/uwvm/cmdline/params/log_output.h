...
UWVM_MODULE_EXPORT namespace uwvm2::uwvm::cmdline::params
{
    namespace details
    {
        ...
        inline constexpr
#endif
            ::uwvm2::utils::cmdline::parameter_return_type log_output_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
# pragma clang diagnostic ignored "-Wbraced-scalar-init"
    ...
    inline constexpr ::uwvm2::utils::cmdline::parameter log_output{
        .name{u8"--log-output"},
        .describe{u8"Set the uwvm log output target. Default: err."},
        .usage{
