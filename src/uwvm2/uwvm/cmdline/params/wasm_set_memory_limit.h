...
UWVM_MODULE_EXPORT namespace uwvm2::uwvm::cmdline::params
{
    namespace details
    {
        inline constexpr ::uwvm2::utils::container::u8string_view wasm_set_memory_limit_alias{u8"-Wmemlim"};
#if defined(UWVM_MODULE)
        extern "C++"
#else
        inline constexpr
#endif
            ::uwvm2::utils::cmdline::parameter_return_type wasm_set_memory_limit_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
