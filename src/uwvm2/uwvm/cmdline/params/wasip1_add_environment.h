...
# if defined(UWVM_IMPORT_WASI_WASIP1)
    ...
    namespace details
    {
        inline constexpr ::uwvm2::utils::container::u8string_view wasip1_add_environment_alias{u8"-I1addenv"};
#  if defined(UWVM_MODULE)
        extern "C++"
#  else
        inline constexpr
#  endif
            ::uwvm2::utils::cmdline::parameter_return_type wasip1_add_environment_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_add_environment{
        ...
        .describe{
            u8"Add/replace a WASI Preview 1 env var (applies even with --wasip1-noinherit-system-environment; overrides --wasip1-delete-system-environment)."},
