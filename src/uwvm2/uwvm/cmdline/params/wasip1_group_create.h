...
#  else
        inline constexpr
#  endif
            ::uwvm2::utils::cmdline::parameter_return_type wasip1_group_create_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_group_create{
