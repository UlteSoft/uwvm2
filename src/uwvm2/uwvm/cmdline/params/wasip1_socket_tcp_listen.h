...
#  else
        inline constexpr
#  endif
            ::uwvm2::utils::cmdline::parameter_return_type wasip1_socket_tcp_listen_callback(::uwvm2::utils::cmdline::parameter_parsing_results*,
...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_socket_tcp_listen{
        ...
        .describe{u8"Create a global-default WASI Preview 1 TCP listening socket."},
