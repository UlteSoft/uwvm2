...
# if defined(UWVM_IMPORT_WASI_WASIP1)
    ...
    namespace details
    {
        inline constexpr ::uwvm2::utils::container::u8string_view wasip1_noinherit_system_environment_alias{u8"-I1nosysenv"};
    }  // namespace details
...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_noinherit_system_environment{
        ...
        .describe{u8"Do not inherit host env vars for WASI Preview 1; ignores --wasip1-delete-system-environment, but --wasip1-add-environment still applies."},
