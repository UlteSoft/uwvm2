...
#  endif
    inline constexpr ::uwvm2::utils::cmdline::parameter wasip1_global_mount_dir{
        .name{u8"--wasip1-global-mount-dir"},
        .describe{u8"Mount a host directory at a global-default WASI Preview 1 guest path."},
        .usage{u8"<wasi dir:str> <system dir:path>"},
        .alias{::uwvm2::utils::cmdline::kns_u8_str_scatter_t{details::wasip1_global_mount_dir_alias.data(), details::wasip1_global_mount_dir_alias.size()}},
        .handle{::std::addressof(details::wasip1_global_mount_dir_callback)},
