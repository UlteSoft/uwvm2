...
# if 0  /// @warning Extension point: future local imported modules need storage flags, preload options, and initializer/linker support.
        /// @todo add more local imported modules here
    // wasip2
