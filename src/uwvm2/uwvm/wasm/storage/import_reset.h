...
UWVM_MODULE_EXPORT namespace uwvm2::uwvm::wasm::storage
{
    ...
    [[nodiscard]] inline constexpr configured_import_reset_vec_t* find_configured_module_import_reset(
    ...
    [[nodiscard]] inline constexpr configured_import_reset_vec_t& upsert_configured_module_import_reset(
        ::uwvm2::utils::container::u8string_view module_name) noexcept
    {
    ...
    [[nodiscard]] inline constexpr configured_import_reset_t& upsert_configured_import_reset(
        ::uwvm2::utils::container::u8string_view module_name,
        ::uwvm2::utils::container::u8string_view import_module_name,
