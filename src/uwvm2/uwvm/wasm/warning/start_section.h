...
{
    inline constexpr void show_wasm_start_section_warning([[maybe_unused]] ::uwvm2::uwvm::wasm::type::wasm_file_t const& wasm,
    ...
    inline constexpr void show_wasm_section_warning(
        ::uwvm2::parser::wasm::concepts::feature_reserve_type_t<::uwvm2::parser::wasm::standard::wasm1::features::start_section_storage_t>,
        ::uwvm2::uwvm::wasm::type::wasm_file_t const& wasm,
        ::uwvm2::uwvm::wasm::warning::binfmt_ver1_warning_storage_t& warn_storage) noexcept
    { return show_wasm_start_section_warning(wasm, warn_storage); }
}
