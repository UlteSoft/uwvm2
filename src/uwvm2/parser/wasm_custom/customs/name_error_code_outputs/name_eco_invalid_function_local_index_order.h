                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             ") The function local index must appear in ascending order: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.name_err.err.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             " < ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.name_err.err.u32arr[1],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             ".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.name_err.curr - errout.name_begin),
                                                             L") The function local index must appear in ascending order: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.name_err.err.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L" < ",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.name_err.curr - errout.name_begin),
                                                             u8") The function local index must appear in ascending order: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.name_err.err.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8" < ",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.name_err.curr - errout.name_begin),
                                                             u") The function local index must appear in ascending order: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.name_err.err.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u" < ",
