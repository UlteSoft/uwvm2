...
if constexpr(::std::same_as<char_type, char>)
{
    wasm1p1_print_error("WebAssembly 1.1 reference type mismatch in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type_mismatch.subject),
                        ". Expected ",
...
{
    wasm1p1_print_error(L"WebAssembly 1.1 reference type mismatch in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type_mismatch.subject),
                        L". Expected ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                        L", got ",
...
{
    wasm1p1_print_error(u8"WebAssembly 1.1 reference type mismatch in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type_mismatch.subject),
                        u8". Expected ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                        u8", got ",
...
{
    wasm1p1_print_error(u"WebAssembly 1.1 reference type mismatch in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type_mismatch.subject),
                        u". Expected ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                        u", got ",
