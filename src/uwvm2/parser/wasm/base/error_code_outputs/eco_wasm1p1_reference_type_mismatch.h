                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                get_wasm1p1_type_name.template operator()<char>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                UWVM_WIN32_TEXTATTR_WHITE,
                " (",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                ...
                "), got ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm1p1_type_name.template operator()<char>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                UWVM_WIN32_TEXTATTR_WHITE,
                " (",
                UWVM_WIN32_TEXTATTR_CYAN,
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                L". Expected ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm1p1_type_name.template operator()<wchar_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                UWVM_WIN32_TEXTATTR_WHITE,
                L" (",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                ...
                L"), got ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm1p1_type_name.template operator()<wchar_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                UWVM_WIN32_TEXTATTR_WHITE,
                L" (",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                u8". Expected ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm1p1_type_name.template operator()<char8_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                UWVM_WIN32_TEXTATTR_WHITE,
                u8" (",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                ...
                u8"), got ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm1p1_type_name.template operator()<char8_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                UWVM_WIN32_TEXTATTR_WHITE,
                u8" (",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                u". Expected ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm1p1_type_name.template operator()<char16_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                UWVM_WIN32_TEXTATTR_WHITE,
                u" (",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                ...
                u"), got ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm1p1_type_name.template operator()<char16_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                UWVM_WIN32_TEXTATTR_WHITE,
                u" (",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                U". Expected ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm1p1_type_name.template operator()<char32_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                UWVM_WIN32_TEXTATTR_WHITE,
                U" (",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.expected),
                ...
                U"), got ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm1p1_type_name.template operator()<char32_t>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
                UWVM_WIN32_TEXTATTR_WHITE,
                U" (",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type_mismatch.actual),
