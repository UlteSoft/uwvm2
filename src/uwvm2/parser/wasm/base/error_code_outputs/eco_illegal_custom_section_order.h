                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             ") Illegal custom section order: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::code_cvt(errout.err.err_selectable.illegal_custom_section_order.custom_name),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             "\", custom_order=",
                                                             errout.err.err_selectable.illegal_custom_section_order.custom_order,
                                                             " < wasm_order=",
                                                             errout.err.err_selectable.illegal_custom_section_order.wasm_order,
                                                             ", wasm_sec=",
                                                             errout.err.err_selectable.illegal_custom_section_order.wasm_sec,
                                                             ".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             L") Illegal custom section order: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::code_cvt(errout.err.err_selectable.illegal_custom_section_order.custom_name),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L"\", custom_order=",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u8") Illegal custom section order: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             // Same type, no conversion required
                                                             errout.err.err_selectable.illegal_custom_section_order.custom_name,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8"\", custom_order=",
                                                             errout.err.err_selectable.illegal_custom_section_order.custom_order,
                                                             u8" < wasm_order=",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u") Illegal custom section order: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::code_cvt(errout.err.err_selectable.illegal_custom_section_order.custom_name),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u"\", custom_order=",
