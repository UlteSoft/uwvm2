                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             ") Constant initialization expression references illegal imported global. Index global[",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[1],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             "] exceeds imported global count ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             L") Constant initialization expression references illegal imported global. Index global[",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[1],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L"] exceeds imported global count ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u8") Constant initialization expression references illegal imported global. Index global[",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[1],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8"] exceeds imported global count ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u") Constant initialization expression references illegal imported global. Index global[",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[1],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u"] exceeds imported global count ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.u32arr[0],
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u".",
