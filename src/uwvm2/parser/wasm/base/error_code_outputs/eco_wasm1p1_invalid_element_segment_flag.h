...
if constexpr(::std::same_as<char_type, char>)
{
    wasm1p1_print_error("Invalid WebAssembly 1.1 element segment flag: ", ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.u32), ".");
}
else if constexpr(::std::same_as<char_type, wchar_t>)
{
    wasm1p1_print_error(L"Invalid WebAssembly 1.1 element segment flag: ", ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.u32), L".");
}
else if constexpr(::std::same_as<char_type, char8_t>)
{
    wasm1p1_print_error(u8"Invalid WebAssembly 1.1 element segment flag: ", ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.u32), u8".");
}
else if constexpr(::std::same_as<char_type, char16_t>)
{
    wasm1p1_print_error(u"Invalid WebAssembly 1.1 element segment flag: ", ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.u32), u".");
}
else if constexpr(::std::same_as<char_type, char32_t>)
{
    wasm1p1_print_error(U"Invalid WebAssembly 1.1 element segment flag: ", ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.u32), U".");
