...
if constexpr(::std::same_as<char_type, char>)
{
    wasm1p1_print_error("Invalid WebAssembly 1.1 reference type in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type.subject),
                        ": ",
...
{
    wasm1p1_print_error(L"Invalid WebAssembly 1.1 reference type in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type.subject),
                        L": ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type.value),
                        L".");
...
{
    wasm1p1_print_error(u8"Invalid WebAssembly 1.1 reference type in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type.subject),
                        u8": ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type.value),
                        u8".");
...
{
    wasm1p1_print_error(u"Invalid WebAssembly 1.1 reference type in ",
                        wasm1p1_subject_name(errout.err.err_selectable.wasm1p1_reference_type.subject),
                        u": ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_reference_type.value),
                        u".");
