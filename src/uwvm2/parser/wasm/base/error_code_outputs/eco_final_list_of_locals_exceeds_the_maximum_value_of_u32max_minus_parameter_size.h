...
auto const parameter_size{errout.err.err_selectable.u32};
constexpr auto wasm_u32_max{::std::numeric_limits<::std::uint_least32_t>::max()};
auto const max_locals{wasm_u32_max - parameter_size};
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                ") The final list of local variables obtained by concatenating all groups must not exceed u32 max minus parameter size (parameter size=",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                L"(offset=",
                ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                L") The final list of local variables obtained by concatenating all groups must not exceed u32 max minus parameter size (parameter size=",
                UWVM_WIN32_TEXTATTR_CYAN,
                parameter_size,
                UWVM_WIN32_TEXTATTR_WHITE,
                L", max locals=",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                u8"(offset=",
                ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                u8") The final list of local variables obtained by concatenating all groups must not exceed u32 max minus parameter size (parameter size=",
                UWVM_WIN32_TEXTATTR_CYAN,
                parameter_size,
                UWVM_WIN32_TEXTATTR_WHITE,
                u8", max locals=",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                u"(offset=",
                ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                u") The final list of local variables obtained by concatenating all groups must not exceed u32 max minus parameter size (parameter size=",
                UWVM_WIN32_TEXTATTR_CYAN,
                parameter_size,
                UWVM_WIN32_TEXTATTR_WHITE,
                u", max locals=",
