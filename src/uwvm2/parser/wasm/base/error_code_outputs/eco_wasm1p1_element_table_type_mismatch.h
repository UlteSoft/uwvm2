...
if constexpr(::std::same_as<char_type, char>)
{
    wasm1p1_print_error("Element segment reference type ",
...
{
    wasm1p1_print_error(L"Element segment reference type ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_element_table_type_mismatch.segment_type),
...
{
    wasm1p1_print_error(u8"Element segment reference type ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_element_table_type_mismatch.segment_type),
...
{
    wasm1p1_print_error(u"Element segment reference type ",
                        ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm1p1_element_table_type_mismatch.segment_type),
