...
constexpr auto get_wasm2_feature_name{[]<::std::integral char_type2>(::uwvm2::parser::wasm::base::wasm2_feature_kind feature) constexpr noexcept
                                        -> ::uwvm2::utils::container::basic_string_view<char_type2>
                                    {
                                        switch(feature)
                                        {
                                            case ::uwvm2::parser::wasm::base::wasm2_feature_kind::table_instructions:
                                            {
                                                if constexpr(::std::same_as<char_type2, char>) { return {"table-instructions"}; }
                                                else if constexpr(::std::same_as<char_type2, wchar_t>) { return {L"table-instructions"}; }
                                                else if constexpr(::std::same_as<char_type2, char8_t>) { return {u8"table-instructions"}; }
                                                else if constexpr(::std::same_as<char_type2, char16_t>) { return {u"table-instructions"}; }
                                                else if constexpr(::std::same_as<char_type2, char32_t>) { return {U"table-instructions"}; }
                                            }
                                            case ::uwvm2::parser::wasm::base::wasm2_feature_kind::multiple_tables:
                                            {
                                                if constexpr(::std::same_as<char_type2, char>) { return {"multiple-tables"}; }
                                                else if constexpr(::std::same_as<char_type2, wchar_t>) { return {L"multiple-tables"}; }
                                                else if constexpr(::std::same_as<char_type2, char8_t>) { return {u8"multiple-tables"}; }
                                                else if constexpr(::std::same_as<char_type2, char16_t>) { return {u"multiple-tables"}; }
                                                else if constexpr(::std::same_as<char_type2, char32_t>) { return {U"multiple-tables"}; }
                                            }
                                            [[unlikely]] default:
                                            {
...
constexpr auto get_wasm2_subject_name{[]<::std::integral char_type2>(::uwvm2::parser::wasm::base::wasm2_error_subject subject) constexpr noexcept
                                        -> ::uwvm2::utils::container::basic_string_view<char_type2>
                                    {
                                        switch(subject)
                                        {
                                            case ::uwvm2::parser::wasm::base::wasm2_error_subject::element_segment:
                                            {
                                            ...
                                            case ::uwvm2::parser::wasm::base::wasm2_error_subject::table_type:
                                            {
                                            ...
                                            case ::uwvm2::parser::wasm::base::wasm2_error_subject::instruction:
                                            {
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                get_wasm2_subject_name.template operator()<char>(errout.err.err_selectable.wasm2_feature_required.subject),
                UWVM_WIN32_TEXTATTR_WHITE,
                " requires ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm2_feature_name.template operator()<char>(errout.err.err_selectable.wasm2_feature_required.feature),
                UWVM_WIN32_TEXTATTR_WHITE,
                " (value ",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm2_feature_required.value),
                UWVM_WIN32_TEXTATTR_WHITE,
                ").",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                L"WebAssembly 2.0 ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm2_subject_name.template operator()<wchar_t>(errout.err.err_selectable.wasm2_feature_required.subject),
                UWVM_WIN32_TEXTATTR_WHITE,
                L" requires ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm2_feature_name.template operator()<wchar_t>(errout.err.err_selectable.wasm2_feature_required.feature),
                UWVM_WIN32_TEXTATTR_WHITE,
                L" (value ",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm2_feature_required.value),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                u8"WebAssembly 2.0 ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm2_subject_name.template operator()<char8_t>(errout.err.err_selectable.wasm2_feature_required.subject),
                UWVM_WIN32_TEXTATTR_WHITE,
                u8" requires ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm2_feature_name.template operator()<char8_t>(errout.err.err_selectable.wasm2_feature_required.feature),
                UWVM_WIN32_TEXTATTR_WHITE,
                u8" (value ",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm2_feature_required.value),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                u"WebAssembly 2.0 ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm2_subject_name.template operator()<char16_t>(errout.err.err_selectable.wasm2_feature_required.subject),
                UWVM_WIN32_TEXTATTR_WHITE,
                u" requires ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm2_feature_name.template operator()<char16_t>(errout.err.err_selectable.wasm2_feature_required.feature),
                UWVM_WIN32_TEXTATTR_WHITE,
                u" (value ",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm2_feature_required.value),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                U"WebAssembly 2.0 ",
                UWVM_WIN32_TEXTATTR_CYAN,
                get_wasm2_subject_name.template operator()<char32_t>(errout.err.err_selectable.wasm2_feature_required.subject),
                UWVM_WIN32_TEXTATTR_WHITE,
                U" requires ",
                UWVM_WIN32_TEXTATTR_LT_GREEN,
                get_wasm2_feature_name.template operator()<char32_t>(errout.err.err_selectable.wasm2_feature_required.feature),
                UWVM_WIN32_TEXTATTR_WHITE,
                U" (value ",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::hex0x<true>(errout.err.err_selectable.wasm2_feature_required.value),
