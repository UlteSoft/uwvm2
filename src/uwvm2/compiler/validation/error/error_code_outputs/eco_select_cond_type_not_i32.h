...
auto const& sctni32{errout.err.err_selectable.select_cond_type_not_i32};

auto const cond_type_name{
    ::uwvm2::parser::wasm::standard::wasm1::type::get_value_name<char_type>(::uwvm2::parser::wasm::standard::wasm1::type::section_details(sctni32.cond_type))};
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             ") Select condition type must be i32, but got: ",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             L") Select condition type must be i32, but got: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             cond_type_name,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u8") Select condition type must be i32, but got: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             cond_type_name,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u") Select condition type must be i32, but got: ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             cond_type_name,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u".",
