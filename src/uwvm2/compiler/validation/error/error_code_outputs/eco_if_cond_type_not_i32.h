...
auto const& ictni32{errout.err.err_selectable.if_cond_type_not_i32};

auto const cond_type_name{
    ::uwvm2::parser::wasm::standard::wasm1::type::get_value_name<char_type>(::uwvm2::parser::wasm::standard::wasm1::type::section_details(ictni32.cond_type))};
