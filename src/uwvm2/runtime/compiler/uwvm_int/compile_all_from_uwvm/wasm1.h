...
UWVM_MODULE_EXPORT namespace uwvm2::runtime::compiler::uwvm_int::compile_all_from_uwvm
{
        ...
        ::uwvm2::validation::error::code_validation_error_impl& err) UWVM_THROWS
    {
        ...
        auto const validate_code{
            [&](::std::size_t const function_index,
                ::uwvm2::uwvm::runtime::storage::wasm_binfmt1_final_function_type_t const& curr_func_type,
                ::uwvm2::uwvm::runtime::storage::wasm_binfmt1_final_wasm_code_t const& curr_code,
                ...
                for(;;)
                {
                    ...
                    switch(curr_opbase)
                    {
                        ...
                        case wasm1_code::br_table:
                        {
                            ...
                            auto const validate_label{[&](wasm_u32 li) constexpr UWVM_THROWS
                                                      {
                                                          if(static_cast<::std::size_t>(li) >= all_label_count_uz) [[unlikely]]
                                                          {
                                                              ...
                                                              err.err_selectable.illegal_label_index.all_label_count =
                                                                  static_cast<wasm_u32>(all_label_count_uz);
                                                              err.err_code = code_validation_error_code::illegal_label_index;
                                                              ::uwvm2::parser::wasm::base::throw_wasm_parse_code(::fast_io::parse_code::invalid);
                                                          }
                                                      }};
                            ...
                            auto const get_sig{
                                [&](wasm_u32 li) constexpr noexcept
                                {
                        ...
                        case wasm1_code::global_get:
                        {
                            ...
                            {
                                auto const& imported_global_rec{
