...
// macro checkers
#pragma push_macro("UWVM_INTERPRETER_OPTYPE_MACRO")
#undef UWVM_INTERPRETER_OPTYPE_MACRO
#define UWVM_INTERPRETER_OPTYPE_MACRO 

#pragma push_macro("UWVM_INTERPRETER_OPFUNC_MACRO")
#undef UWVM_INTERPRETER_OPFUNC_MACRO
#define UWVM_INTERPRETER_OPFUNC_MACRO UWVM_INTERPRETER_OPTYPE_MACRO UWVM_GNU_HOT
