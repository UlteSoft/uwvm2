...
# endif
        ...
        UWVM_ALWAYS_INLINE inline constexpr FloatIn trunc_float_to_int_s_lower_exclusive() noexcept
        {
            static_assert(::std::numeric_limits<FloatIn>::is_iec559 && ::std::numeric_limits<FloatIn>::radix == 2);

            constexpr FloatIn min_v{static_cast<FloatIn>(::std::numeric_limits<IntOut>::min())};
            constexpr FloatIn rounded_min_minus_one{
                static_cast<FloatIn>(static_cast<long double>(::std::numeric_limits<IntOut>::min()) - 1.0L)};
            if constexpr(rounded_min_minus_one < min_v)
            {
                return rounded_min_minus_one;
            }
            else if constexpr(sizeof(FloatIn) == sizeof(::std::uint32_t))
            {
                // At a negative power-of-two boundary, incrementing the IEEE bit pattern gives the
                // adjacent representable value toward -infinity.
                return ::std::bit_cast<FloatIn>(::std::bit_cast<::std::uint32_t>(min_v) + 1u);
            }
            else if constexpr(sizeof(FloatIn) == sizeof(::std::uint64_t))
            {
                return ::std::bit_cast<FloatIn>(::std::bit_cast<::std::uint64_t>(min_v) + 1u);
            }
            else
            {
                static_assert(sizeof(FloatIn) == sizeof(::std::uint32_t) || sizeof(FloatIn) == sizeof(::std::uint64_t));
            }
        }

        template <typename IntOut, typename FloatIn>
        UWVM_ALWAYS_INLINE inline constexpr bool trunc_float_to_int_s_in_range(FloatIn x) noexcept
        {
            constexpr FloatIn min_exclusive{trunc_float_to_int_s_lower_exclusive<IntOut, FloatIn>()};
            constexpr FloatIn max_plus_one{static_cast<FloatIn>(static_cast<long double>(::std::numeric_limits<IntOut>::max()) + 1.0L)};
            return x > min_exclusive && x < max_plus_one;
        }

        template <typename UIntOut, typename FloatIn>
        UWVM_ALWAYS_INLINE inline constexpr bool trunc_float_to_int_u_in_range(FloatIn x) noexcept
        {
            constexpr FloatIn max_plus_one{static_cast<FloatIn>(static_cast<long double>(::std::numeric_limits<UIntOut>::max()) + 1.0L)};
            return x > static_cast<FloatIn>(-1) && x < max_plus_one;
        }

        template <typename IntOut, typename FloatIn>
        UWVM_ALWAYS_INLINE inline constexpr IntOut trunc_float_to_int_s(FloatIn x) noexcept
        {
            if(trunc_float_to_int_s_in_range<IntOut>(x)) [[likely]]
            {
        ...
        {
            if(trunc_float_to_int_u_in_range<UIntOut>(x)) [[likely]]
            {
    ...
    UWVM_INTERPRETER_OPFUNC_HOT_MACRO inline constexpr void uwvmint_i32_trunc_f32_s(Type... type) UWVM_THROWS
    {
        ...
        if constexpr(details::convert_stacktop_enabled_for<CompileOption, wasm_f32>())
        {
            ...
            wasm_f32 const v{get_curr_val_from_operand_stack_top<CompileOption, wasm_f32, curr_f32_stack_top>(type...)};
            if(!details::trunc_float_to_int_s_in_range<out_i32_t>(v)) [[unlikely]]
            {
    ...
    UWVM_INTERPRETER_OPFUNC_HOT_MACRO inline constexpr void uwvmint_i32_trunc_f32_u(Type... type) UWVM_THROWS
    {
        ...
        if constexpr(details::convert_stacktop_enabled_for<CompileOption, wasm_f32>())
        {
            ...
            wasm_f32 const v{get_curr_val_from_operand_stack_top<CompileOption, wasm_f32, curr_f32_stack_top>(type...)};
            if(!details::trunc_float_to_int_u_in_range<out_u32_t>(v)) [[unlikely]]
            {
                if(v != v) [[unlikely]] { UWVM_MUSTTAIL return details::trap_invalid_conversion_to_integer_tail<CompileOption>(type...); }
                UWVM_MUSTTAIL return details::trap_integer_overflow_tail<CompileOption>(type...);
            }
    ...
    UWVM_INTERPRETER_OPFUNC_HOT_MACRO inline constexpr void uwvmint_i64_trunc_f32_s(Type... type) UWVM_THROWS
    {
        ...
        if constexpr(details::convert_stacktop_enabled_for<CompileOption, wasm_f32>())
        {
            ...
            wasm_f32 const v{get_curr_val_from_operand_stack_top<CompileOption, wasm_f32, curr_f32_stack_top>(type...)};
            if(!details::trunc_float_to_int_s_in_range<out_i64_t>(v)) [[unlikely]]
            {
                if(v != v) [[unlikely]] { UWVM_MUSTTAIL return details::trap_invalid_conversion_to_integer_tail<CompileOption>(type...); }
                UWVM_MUSTTAIL return details::trap_integer_overflow_tail<CompileOption>(type...);
            }
    ...
    UWVM_INTERPRETER_OPFUNC_HOT_MACRO inline constexpr void uwvmint_i64_trunc_f32_u(Type... type) UWVM_THROWS
    {
        ...
        if constexpr(details::convert_stacktop_enabled_for<CompileOption, wasm_f32>())
        {
            ...
            wasm_f32 const v{get_curr_val_from_operand_stack_top<CompileOption, wasm_f32, curr_f32_stack_top>(type...)};
            if(!details::trunc_float_to_int_u_in_range<out_u64_t>(v)) [[unlikely]]
            {
                if(v != v) [[unlikely]] { UWVM_MUSTTAIL return details::trap_invalid_conversion_to_integer_tail<CompileOption>(type...); }
                UWVM_MUSTTAIL return details::trap_integer_overflow_tail<CompileOption>(type...);
            }
    ...
    namespace translate
    {
        namespace details
        {
            ...
            template <uwvm_interpreter_translate_option_t CompileOption,
                      ...
                      uwvm_int_stack_top_type... Type>
                requires (CompileOption.is_tail_call)
            inline constexpr uwvm_interpreter_opfunc_t<Type...> select_stacktop_fptr_by_currpos_convert_impl(::std::size_t pos) noexcept
            {
                ...
                else
                {
                    ...
                    {
                        return select_stacktop_fptr_by_currpos_convert_impl<CompileOption, Curr + 1uz, End, OpWrapper, Type...>(pos);
                    }
                    else
                    {
# if (defined(_DEBUG) || defined(DEBUG)) && defined(UWVM_ENABLE_DETAILED_DEBUG_CHECK)
...
# endif
            ...
            inline constexpr ::std::size_t stacktop_currpos_convert(uwvm_interpreter_stacktop_currpos_t const& curr_stacktop) noexcept
            {
            ...
            template <uwvm_interpreter_translate_option_t CompileOption,
                      ...
                      uwvm_int_stack_top_type... Type>
                requires (CompileOption.is_tail_call)
            inline constexpr uwvm_interpreter_opfunc_t<Type...> select_stacktop_fptr_by_currpos_convert_impl_2d(::std::size_t out_pos,
                                                                                                                ::std::size_t in_pos) noexcept
            {
                ...
                if(out_pos == OutCurr)
                {
                    ...
                    else
                    {
                        ...
                        {
                            return select_stacktop_fptr_by_currpos_convert_impl_2d<CompileOption, OutCurr, OutEnd, InCurr + 1uz, InEnd, OpWrapper, Type...>(
                                out_pos,
                                in_pos);
                        }
                        else
...
# endif
                ...
                else
                {
                    ...
                    {
                        return select_stacktop_fptr_by_currpos_convert_impl_2d<CompileOption, OutCurr + 1uz, OutEnd, InCurr, InEnd, OpWrapper, Type...>(out_pos,
                                                                                                                                                        in_pos);
                    }
                    else
                    {
...
# endif
            ...
            inline constexpr uwvm_interpreter_opfunc_t<Type...> select_unary_convert_fptr(uwvm_interpreter_stacktop_currpos_t const& curr_stacktop) noexcept
            {
                if constexpr(InBegin != InEnd)
                {
                    if constexpr(OutBegin != OutEnd)
                    {
                        ...
                        {
                            return select_stacktop_fptr_by_currpos_convert_impl<CompileOption, InBegin, InEnd, OpWrapper1D, Type...>(
                                stacktop_currpos_convert<InT>(curr_stacktop));
                        }
                        else
                        {
                            return select_stacktop_fptr_by_currpos_convert_impl_2d<CompileOption, OutBegin, OutEnd, InBegin, InEnd, OpWrapper2D, Type...>(
                                stacktop_currpos_convert<OutT>(curr_stacktop),
                                stacktop_currpos_convert<InT>(curr_stacktop));
                        }
                    }
                    else
                ...
                else
                {
                    if constexpr(OutBegin != OutEnd)
                    {
                        return select_stacktop_fptr_by_currpos_convert_impl<CompileOption, OutBegin, OutEnd, OpWrapperOutOnly, Type...>(
                            stacktop_currpos_convert<OutT>(curr_stacktop));
                    }
                    else
                    {
            ...
            struct i32_wrap_i64_op
            {
                ...
                { return uwvmint_i32_wrap_i64<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i32_trunc_f32_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i32_trunc_f32_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i32_trunc_f32_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i32_trunc_f32_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i32_trunc_f64_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i32_trunc_f64_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i32_trunc_f64_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i32_trunc_f64_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_extend_i32_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_extend_i32_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_extend_i32_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_extend_i32_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_trunc_f32_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_trunc_f32_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_trunc_f32_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_trunc_f32_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_trunc_f64_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_trunc_f64_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_trunc_f64_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_trunc_f64_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f32_convert_i32_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f32_convert_i32_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f32_convert_i32_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f32_convert_i32_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f32_convert_i64_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f32_convert_i64_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f32_convert_i64_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f32_convert_i64_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f32_demote_f64_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f32_demote_f64<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f64_convert_i32_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f64_convert_i32_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f64_convert_i32_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f64_convert_i32_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f64_convert_i64_s_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f64_convert_i64_s<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f64_convert_i64_u_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f64_convert_i64_u<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f64_promote_f32_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f64_promote_f32<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i32_reinterpret_f32_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i32_reinterpret_f32<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct i64_reinterpret_f64_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_i64_reinterpret_f64<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f32_reinterpret_i32_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f32_reinterpret_i32<Opt, Pos, Pos, Type...>; }
            };
            ...
            struct f64_reinterpret_i64_op
            {
                template <uwvm_interpreter_translate_option_t Opt, ::std::size_t Pos, uwvm_int_stack_top_type... Type>
                inline static constexpr uwvm_interpreter_opfunc_t<Type...> fptr() noexcept
                { return uwvmint_f64_reinterpret_i64<Opt, Pos, Pos, Type...>; }
            };
