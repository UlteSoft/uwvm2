...
UWVM_MODULE_EXPORT namespace uwvm2::runtime::compiler::uwvm_int::optable
{
    ...
    UWVM_INTERPRETER_OPFUNC_MACRO inline constexpr void uwvmint_for_i32_inc_f64_lt_u_eqz_br_if(Type... type) UWVM_THROWS
    {
        ...
        // WebAssembly `f64.convert_i32_u`: reinterpret i32 bits as u32, then convert to f64.
    ...
    UWVM_INTERPRETER_OPFUNC_MACRO inline constexpr void uwvmint_prime_divisor_loop_run(Type... type) UWVM_THROWS
    {
        ...
        {
            wasm_i32 const rem{
                numeric_details::eval_int_binop<numeric_details::int_binop::rem_u, wasm_i32, numeric_details::wasm_u32>(n, i)};
            if(rem == wasm_i32{})
            {
                type...[0] = break_ip;
                break;
