...
UWVM_MODULE_EXPORT namespace uwvm2::runtime::compiler::llvm_jit::compile_cu_from_lazy_validator
{
    ...
    [[nodiscard]] inline constexpr ::uwvm2::runtime::llvm_jit_cache::cache_policy lazy_llvm_jit_object_cache_policy() noexcept
    {
        ...
        // These MCJIT targets may materialize process-local runtime storage or bridge pointers into lazy objects.
        // Such constants must not be reused from the cross-process object cache.
        policy.enable = false;
#endif
        return policy;
    }
...
# endif
                                                                            ...
                                                                            llvm_jit_module_storage_t& llvm_ir_storage) noexcept
        {
            ...
            ::uwvm2::runtime::llvm_jit_cache::llvm_jit_object_cache llvm_jit_object_cache{
                ::std::move(llvm_jit_cache_context), lazy_llvm_jit_object_cache_policy()};
