...
// memory.size
// Stack effect: () -> (i32 current_pages). WebAssembly 1.0/MVP encodes the reserved memory index
// as one literal byte, and that byte must be 0x00.
...
// same WebAssembly 1.0/MVP reserved byte rule as `memory.size`, and the delta operand must be i32.
