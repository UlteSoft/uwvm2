...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    /// @details   __wasi_errno_t path_readlink_wasm64(__wasi_fd_t fd, const char *path, const uint8_t *buf, size_t buf_len, size_t *buf_used);

    inline ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t path_readlink_wasm64(
...
# else
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: path_readlink_wasm64(",
                                fd,
                                u8", ",
                                ::fast_io::mnp::addrvw(path_ptrsz),
                                u8", ",
...
# endif
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_path_readlink) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_path_readlink) [[unlikely]]
        {
...
# endif
        ...
        if constexpr(::std::numeric_limits<::uwvm2::imported::wasi::wasip1::abi::wasi_size_wasm64_t>::max() > ::std::numeric_limits<::std::size_t>::max())
        {
            ...
            if(buf_len > ::std::numeric_limits<::std::size_t>::max()) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::eoverflow; }
        }
...
# endif
        ...
        ::uwvm2::imported::wasi::wasip1::memory::store_basic_wasm_type_to_memory_wasm64_unchecked(
            memory,
            buf_used_ptrsz,
            static_cast<::uwvm2::imported::wasi::wasip1::abi::wasi_size_wasm64_t>(symlink_symbol_size));

        if(symlink_symbol_size > buf_len) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::enobufs; }
