...
{
    /// @brief     WasiPreview1.path_remove_directory
    /// @details   __wasi_errno_t path_remove_directory(__wasi_fd_t fd, const char *path, size_t path_len);

    inline ::uwvm2::imported::wasi::wasip1::abi::errno_t path_remove_directory(
...
# else
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: path_remove_directory(",
                                fd,
                                u8", ",
                                ::fast_io::mnp::addrvw(path_ptrsz),
                                u8", ",
...
# endif
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_remove_directory) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_remove_directory) [[unlikely]]
        {
...
#   endif
                                    {
                                        ...
                                        {
                                            ++counter;
                                            if(counter > 2u) { return ::uwvm2::imported::wasi::wasip1::abi::errno_t::enotempty; }
                                        }
                                    }
#   ifdef UWVM_CPP_EXCEPTIONS
                                    catch(::fast_io::error e)
