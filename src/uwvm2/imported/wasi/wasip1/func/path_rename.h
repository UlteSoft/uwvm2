...
{
    /// @brief     WasiPreview1.path_rename
...
# else
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: path_rename(",
                                old_fd,
                                u8", ",
                                ::fast_io::mnp::addrvw(old_path_ptrsz),
                                u8", ",
...
# endif
        ...
        if((curr_old_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_rename_source) !=
               ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_rename_source ||
           (curr_new_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_rename_target) !=
               ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_rename_target) [[unlikely]]
        {
        ...
        for(auto new_path_split_curr{new_path_split_path_res.res.cbegin()}; new_path_split_curr != new_path_split_path_res.res.cend(); ++new_path_split_curr)
        {
            if(new_path_split_curr == new_path_split_last)
            {
                ...
                switch(new_path_split_curr->dir_type)
                {
                    ...
                    {
                        // POSIX 3p specifies that the new path ending with curr returns einval.
                        return ::uwvm2::imported::wasi::wasip1::abi::errno_t::einval;
                    }
                    case ::uwvm2::imported::wasi::wasip1::func::dir_type_e::prev:
                    {
                        // POSIX 3p specifies that the new path ending with prev returns einval.
                        return ::uwvm2::imported::wasi::wasip1::abi::errno_t::einval;
                    }
        ...
        for(auto old_path_split_curr{old_path_split_path_res.res.begin()}; old_path_split_curr != old_path_split_path_res.res.end(); ++old_path_split_curr)
        {
            if(old_path_split_curr == old_path_split_last)
            {
                ...
                switch(old_path_split_curr->dir_type)
                {
                    ...
                    {
                        // old is dir
                        // POSIX 3p specifies that the old path ending with curr returns einval.
                        return ::uwvm2::imported::wasi::wasip1::abi::errno_t::einval;
                    }
                    case ::uwvm2::imported::wasi::wasip1::func::dir_type_e::prev:
                    {
                        // old is dir
                        // POSIX 3p specifies that the old path ending with prev returns einval.
                        return ::uwvm2::imported::wasi::wasip1::abi::errno_t::einval;
                    }
                    case ::uwvm2::imported::wasi::wasip1::func::dir_type_e::next:
                    {
