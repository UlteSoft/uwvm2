...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_t fd_filestat_get(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<8uz>(stat_ptrsz, u8"fd_filestat_get.stat (filestat)");

        auto const trace_wasip1_call{env.trace_wasip1_call};

        if(trace_wasip1_call) [[unlikely]]
        {
            ::uwvm2::imported::wasi::wasip1::func::print_wasip1_trace_message(env, u8"fd_filestat_get(", fd, u8", ", ::fast_io::mnp::addrvw(stat_ptrsz), u8")");
        }
