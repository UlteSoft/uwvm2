...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_t fd_tell(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<8uz>(tell_ptrsz, u8"fd_tell.offset (filesize)");

        auto const trace_wasip1_call{env.trace_wasip1_call};

        if(trace_wasip1_call) [[unlikely]]
        {
            ::uwvm2::imported::wasi::wasip1::func::print_wasip1_trace_message(env, u8"fd_tell(", fd, u8", ", ::fast_io::mnp::addrvw(tell_ptrsz), u8")");
        }
