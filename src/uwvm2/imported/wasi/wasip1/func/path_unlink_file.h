...
{
    /// @brief     WasiPreview1.path_unlink_file
    /// @details   __wasi_errno_t path_unlink_file(__wasi_fd_t fd, const char *path, size_t path_len);

    inline ::uwvm2::imported::wasi::wasip1::abi::errno_t path_unlink_file(
        ...
        ::uwvm2::imported::wasi::wasip1::abi::wasi_size_t path_len) noexcept
    {
        ...
        if(trace_wasip1_call) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: path_unlink_file(",
                                fd,
                                u8", ",
                                ::fast_io::mnp::addrvw(path_ptrsz),
                                u8", ",
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_unlink_file) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_unlink_file) [[unlikely]]
        {
...
# endif
                                ...
                                if(is_dir) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_t::eisdir; }
#endif

                                // native_unlinkat default nofollow
                                ::fast_io::native_unlinkat(at(curr_fd_native_file), open_file_name);
                            }
#ifdef UWVM_CPP_EXCEPTIONS
...
# endif
                                ...
                                // native_unlinkat default nofollow
                                ::fast_io::native_unlinkat(at(path_stack.back_unchecked()), open_file_name);
                            }
#ifdef UWVM_CPP_EXCEPTIONS
                            catch(::fast_io::error e)
                            {
