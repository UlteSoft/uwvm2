...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    /// @details   __wasi_errno_t path_readlink(__wasi_fd_t fd, const char *path, const uint8_t *buf, size_t buf_len, size_t *buf_used);

    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_t path_readlink(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<4uz>(buf_used_ptrsz, u8"path_readlink.buf_used (size)");
...
# endif
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_readlink) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_path_readlink) [[unlikely]]
        {
...
# endif
        ...
        // check memory bounds
        ::uwvm2::imported::wasi::wasip1::memory::check_memory_bounds_wasm32(memory, buf_ptrsz, buf_len);
        ::uwvm2::imported::wasi::wasip1::memory::check_memory_bounds_wasm32(memory, buf_used_ptrsz, sizeof(::uwvm2::imported::wasi::wasip1::abi::wasi_size_t));
        ...
        if constexpr(::std::numeric_limits<::uwvm2::imported::wasi::wasip1::abi::wasi_size_t>::max() > ::std::numeric_limits<::std::size_t>::max())
        {
            ...
            if(buf_len > ::std::numeric_limits<::std::size_t>::max()) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_t::eoverflow; }
        }
...
# endif
        ...
        // wasi permits access to symlinks of any type, but some may not be accessible.
        if(!env.disable_utf8_check) [[likely]]
        {
            auto const u8res{
