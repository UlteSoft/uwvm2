...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t fd_write_wasm64(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<8uz>(iovs, u8"fd_write_wasm64.iovs (ciovec64)");
        check_wasip1_guest_pointer_alignment<8uz>(nwritten, u8"fd_write_wasm64.nwritten (size64)");
...
#  endif
                    {
                        scatter_status = ::fast_io::operations::scatter_write_some_bytes(curr_fd_native_observer, scatter_base, scatter_length);
                    }
#  ifdef UWVM_CPP_EXCEPTIONS
...
#  endif
                    {
                        scatter_status = ::fast_io::operations::scatter_write_some_bytes(curr_socket_observer, scatter_base, scatter_length);
                    }
#  ifdef UWVM_CPP_EXCEPTIONS
                    catch(::fast_io::error e)
                    {
