...
# else
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: path_unlink_file_wasm64(",
                                fd,
                                u8", ",
                                ::fast_io::mnp::addrvw(path_ptrsz),
                                u8", ",
...
# endif
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_path_unlink_file) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_path_unlink_file) [[unlikely]]
        {
...
#  endif
                                ...
                                if(is_dir) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::eisdir; }
# endif
