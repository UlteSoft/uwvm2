...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    inline ::uwvm2::imported::wasi::wasip1::abi::errno_t path_readlink(
        ...
        ::uwvm2::imported::wasi::wasip1::abi::wasi_void_ptr_t buf_used_ptrsz) noexcept
    {
        ...
        if(trace_wasip1_call) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: path_readlink(",
                                fd,
                                u8", ",
                                ::fast_io::mnp::addrvw(path_ptrsz),
                                u8", ",
...
// This will be checked at runtime.
        ...
        // check memory bounds
        ::uwvm2::imported::wasi::wasip1::memory::check_memory_bounds_wasm32(memory, path_ptrsz, path_len);
...
# endif
        ...
        if(symlink_symbol_size > buf_len) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_t::enametoolong; }
