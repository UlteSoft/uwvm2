...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t fd_tell_wasm64(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<8uz>(tell_ptrsz, u8"fd_tell_wasm64.offset (filesize)");
