...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    /// *nwritten);
    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_t fd_pwrite(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<4uz>(iovs, u8"fd_pwrite.iovs (ciovec)");
        check_wasip1_guest_pointer_alignment<4uz>(nwritten, u8"fd_pwrite.nwritten (size)");
...
#  endif
                ...
                scatter_status = ::fast_io::operations::scatter_pwrite_some_bytes(curr_fd_native_observer, scatter_base, scatter_length, scatter_p_off);
