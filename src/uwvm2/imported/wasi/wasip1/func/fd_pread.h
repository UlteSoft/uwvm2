...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    ///           *nread);
    inline constexpr ::uwvm2::imported::wasi::wasip1::abi::errno_t fd_pread(
...
# endif
        ...
        check_wasip1_guest_pointer_alignment<4uz>(iovs, u8"fd_pread.iovs (iovec)");
        check_wasip1_guest_pointer_alignment<4uz>(nread, u8"fd_pread.nread (size)");
