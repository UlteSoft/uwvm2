...
UWVM_MODULE_EXPORT namespace uwvm2::validation::standard::wasm2
{
    ...
    template <::uwvm2::parser::wasm::concepts::wasm_feature... Fs>
    inline constexpr void validate_code(::uwvm2::parser::wasm::standard::wasm2::features::wasm2_code_version,
        ...
        auto const validate_mem_load{[&](::uwvm2::utils::container::u8string_view op_name,
                                         ...
                                         curr_operand_stack_value_type const result_type) constexpr UWVM_THROWS
                                     {
                                         ...
                                         auto const addr{try_pop_concrete_operand()};
                                             if(!operand_type_matches(addr, curr_operand_stack_value_type::i32)) [[unlikely]]
                                             {
                                                 err.err_curr = op_begin;
    ...
    template <::uwvm2::parser::wasm::concepts::wasm_feature... Fs>
    inline constexpr void validate_code(::uwvm2::parser::wasm::standard::wasm2::features::wasm2_code_version code_version,
                                        ::uwvm2::parser::wasm::binfmt::ver1::wasm_binfmt_ver1_module_extensible_storage_t<Fs...> const& module_storage,
                                        ::std::size_t const function_index,
                                        ::std::byte const* code_begin,
                                        ::std::byte const* code_end,
                                        ::uwvm2::validation::error::code_validation_error_impl& err) UWVM_THROWS
    {
        ...
        ::uwvm2::validation::standard::wasm2::validate_code(code_version, module_storage, function_index, code_begin, code_end, err, fs_para);
    }

    /// @brief Select the code-validation standard requested by the runtime command-line policy.
    /// @details The native default remains wasm1p1. A direct Wasm 2.0 selector or any scoped Wasm 2.0 feature policy
    ///          opts into the Release 2.0 validator; MVP and direct wasm1p1 selectors retain the established validator.
    [[nodiscard]] inline constexpr bool use_wasm2_runtime_validation_strategy(
        ::uwvm2::parser::wasm::standard::wasm1p1::features::wasm_binfmt1p1_feature_parameter const& parameter) noexcept
    {
        using cli_mode = ::uwvm2::parser::wasm::standard::wasm1p1::features::wasm_feature_cli_mode;
        return parameter.cli_mode == cli_mode::direct_wasm2 || parameter.cli_mode == cli_mode::scoped;
    }

    /// @brief Runtime COP boundary preserving the native wasm1p1 target while allowing an explicit Wasm 2.0 strategy.
    /// @warning Every runtime compiler/validator entry must call this boundary instead of inferring a version from the
    ///          compile-time storage tuple; Wasm 2.0 shares binary-format version 1 and the same runtime storage substrate.
    template <::uwvm2::parser::wasm::concepts::wasm_feature... Fs>
    inline constexpr void validate_code_with_runtime_policy(
        ...
        ::uwvm2::parser::wasm::concepts::feature_parameter_t<Fs...> const& fs_para) UWVM_THROWS
    {
        auto const& parameter{::uwvm2::parser::wasm::standard::wasm1p1::features::get_wasm1p1_parameter(fs_para)};
        if(use_wasm2_runtime_validation_strategy(parameter))
        {
...
/// @brief COP/ADL bridge for the parser-owned MVP code-version tag.
...
/// @brief COP/ADL bridge for the parser-owned wasm1p1 code-version tag.
/// @details The legacy validator remains untouched; this bridge only exposes it through the parser composition point.
UWVM_MODULE_EXPORT namespace uwvm2::parser::wasm::standard::wasm1p1::features
{
    ...
    {
        ::uwvm2::validation::standard::wasm1p1::validate_code(
            ::uwvm2::validation::standard::wasm1p1::wasm1p1_code_version{}, module_storage, function_index, code_begin, code_end, err);
    }
}

/// @brief COP/ADL bridge from the parser-owned code-version tag to the WebAssembly 2.0 validation strategy.
/// @details Keeping the bridge in the tag's associated namespace lets generic validation dispatch select this policy without coupling callers to a concrete
/// validator namespace.
UWVM_MODULE_EXPORT namespace uwvm2::parser::wasm::standard::wasm2::features
{
    ...
    inline constexpr void validate_code(
        ...
        ::std::byte const* code_end,
        ::uwvm2::validation::error::code_validation_error_impl& err) UWVM_THROWS
    { ::uwvm2::validation::standard::wasm2::validate_code(code_version, module_storage, function_index, code_begin, code_end, err); }
}
