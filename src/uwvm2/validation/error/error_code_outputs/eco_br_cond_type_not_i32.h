...
auto const& bctni32{errout.err.err_selectable.br_cond_type_not_i32};

auto const cond_type_name{
    ::uwvm2::parser::wasm::standard::wasm1::type::get_value_name<char_type>(::uwvm2::parser::wasm::standard::wasm1::type::section_details(bctni32.cond_type))};
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8" condition/index type must be ",
                                                             UWVM_WIN32_TEXTATTR_YELLOW,
                                                             u8"i32",
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8", but got: ",
