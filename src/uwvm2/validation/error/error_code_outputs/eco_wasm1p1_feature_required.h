                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             get_wasm1p1_feature_name.template operator()<char>(wfr.feature),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             " (value ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L" requires ",
                                                             UWVM_WIN32_TEXTATTR_LT_GREEN,
                                                             get_wasm1p1_feature_name.template operator()<wchar_t>(wfr.feature),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L" (value ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::hex0x<true>(wfr.value),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8" requires ",
                                                             UWVM_WIN32_TEXTATTR_LT_GREEN,
                                                             get_wasm1p1_feature_name.template operator()<char8_t>(wfr.feature),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8" (value ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::hex0x<true>(wfr.value),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u" requires ",
                                                             UWVM_WIN32_TEXTATTR_LT_GREEN,
                                                             get_wasm1p1_feature_name.template operator()<char16_t>(wfr.feature),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u" (value ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::hex0x<true>(wfr.value),
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             U" requires ",
                                                             UWVM_WIN32_TEXTATTR_LT_GREEN,
                                                             get_wasm1p1_feature_name.template operator()<char32_t>(wfr.feature),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             U" (value ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::hex0x<true>(wfr.value),
