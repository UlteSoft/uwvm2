...
auto const& igs{errout.err.err_selectable.immutable_global_set};
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             ") global.set requires a mutable global, but global index ",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             L") global.set requires a mutable global, but global index ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             igs.global_index,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L" is immutable.",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u8") global.set requires a mutable global, but global index ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             igs.global_index,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8" is immutable.",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u") global.set requires a mutable global, but global index ",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             igs.global_index,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u" is immutable.",
