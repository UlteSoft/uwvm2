...
#pragma comment(linker,"/alternatename:__imp_?NtMapViewOfSectionEx@nt@win32@fast_io@@YGIPAX0PAPAXPBTlarge_integer@123@PAIII0I@Z=__imp__NtMapViewOfSectionEx@36")
#pragma comment(linker,"/alternatename:__imp_?ZwMapViewOfSectionEx@nt@win32@fast_io@@YGIPAX0PAPAXPBTlarge_integer@123@PAIII0I@Z=__imp__ZwMapViewOfSectionEx@36")
...
#pragma comment(linker,"/alternatename:__imp_?NtAllocateVirtualMemoryEx@nt@win32@fast_io@@YGIPAXPAPAXPAIII0I@Z=__imp__NtAllocateVirtualMemoryEx@28")
#pragma comment(linker,"/alternatename:__imp_?ZwAllocateVirtualMemoryEx@nt@win32@fast_io@@YGIPAXPAPAXPAIII0I@Z=__imp__ZwAllocateVirtualMemoryEx@28")
