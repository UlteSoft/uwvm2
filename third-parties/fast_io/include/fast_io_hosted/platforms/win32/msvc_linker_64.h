...
#pragma comment(linker,"/alternatename:__imp_?NtMapViewOfSectionEx@nt@win32@fast_io@@YAIPEAX0PEAPEAXPEBTlarge_integer@123@PEA_KII0I@Z=__imp_NtMapViewOfSectionEx")
#pragma comment(linker,"/alternatename:__imp_?ZwMapViewOfSectionEx@nt@win32@fast_io@@YAIPEAX0PEAPEAXPEBTlarge_integer@123@PEA_KII0I@Z=__imp_ZwMapViewOfSectionEx")
...
#pragma comment(linker,"/alternatename:__imp_?NtAllocateVirtualMemoryEx@nt@win32@fast_io@@YAIPEAXPEAPEAXPEA_KII0I@Z=__imp_NtAllocateVirtualMemoryEx")
#pragma comment(linker,"/alternatename:__imp_?ZwAllocateVirtualMemoryEx@nt@win32@fast_io@@YAIPEAXPEAPEAXPEA_KII0I@Z=__imp_ZwAllocateVirtualMemoryEx")
