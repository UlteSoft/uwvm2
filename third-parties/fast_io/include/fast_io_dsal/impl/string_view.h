...
print_reserve_size(::fast_io::io_reserve_type_t<char_type, ::fast_io::containers::basic_string_view<char_type>>,
				   ::fast_io::containers::basic_string_view<char_type> str) noexcept
{
	return str.n;
}
...
print_reserve_define(::fast_io::io_reserve_type_t<char_type, ::fast_io::containers::basic_string_view<char_type>>,
					 char_type *iter, ::fast_io::containers::basic_string_view<char_type> str) noexcept
{
...
template <::std::integral char_type>
inline constexpr ::std::size_t
print_reserve_precise_size(::fast_io::io_reserve_type_t<char_type, ::fast_io::containers::basic_string_view<char_type>>,
						   ::fast_io::containers::basic_string_view<char_type> str) noexcept
{
	return str.n;
}
...
template <::std::integral char_type>
inline constexpr char_type *
print_reserve_precise_define(::fast_io::io_reserve_type_t<char_type, ::fast_io::containers::basic_string_view<char_type>>,
