...
static bool isIntrinsicInline(Function *F) {
  // Intrinsic operands can include metadata and have no native call ABI.
  // Do not synthesize a physical FP-call stub for a constrained intrinsic;
  // SelectionDAG lowers it (and any required real libcall) later.
  if (F->isIntrinsic())
    return true;
