...
Mips16TargetLowering::emitSel16(unsigned Opc, MachineInstr &MI,
  ...
  // Selection can occur inside argument setup after ADJCALLSTACKDOWN.
  // Both new entries inherit that active frame; zero would contradict the
  // predecessor and corrupt later stack/frame reasoning.
