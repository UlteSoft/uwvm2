...
void MipsSEInstrInfo::copyPhysReg(MachineBasicBlock &MBB,
  ...
  // microMIPS has the same physical low-word copy semantics. Its MC emitter
  // must select the compressed encoding for these private FGR64 variants;
  // retaining the instruction-neighbor heuristic here is not safe either.
